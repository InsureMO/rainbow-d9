...
export const RemoveRoute = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="o23-remove-route" viewBox="0 0 24 24" fill="none"
		...
		<path
			...
			stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
		<path opacity="0.4" d="M7 12H14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
		...
		<path d="M6.06922 20.0402L3.94922 17.9302" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10"
		      strokeLinecap="round" strokeLinejoin="round"/>
		<path d="M6.04969 17.96L3.92969 20.0699" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10"
		      strokeLinecap="round" strokeLinejoin="round"/>
	</svg>;
};
