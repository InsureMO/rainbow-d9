...
export const UnfoldSubNodes = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="o23-unfold-sub-nodes" viewBox="0 0 24 24" fill="none"
		...
		<g opacity="0.4">
			...
			<path d="M18 4H14C12 4 11 5 11 7V17C11 19 12 20 14 20H18" stroke="currentColor" strokeWidth="1.5"
