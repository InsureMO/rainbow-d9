...
export const InsertStep = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="o23-insert-step" viewBox="0 0 24 24" fill="none"
		...
		<path d="M6 12L15 12M15 12L12.5 14.5M15 12L12.5 9.5" stroke="currentColor" strokeWidth="1.5"
		      strokeLinecap="round"
