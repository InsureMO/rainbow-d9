...
export const PlaygroundCssVars = {
	...
	NODE_NEXT_STEP_PORT_BACKGROUND: `var(--o23-playground-next-step-port-background, linear-gradient(135deg, ${color(NEXT_STEP_PORT_COLOR).lighten(0.5)} 0%, ${NEXT_STEP_PORT_COLOR} 40%, ${color(NEXT_STEP_PORT_COLOR).darken(0.5)} 100%))`,
	...
	NODE_END_BODY_PADDING: `var(--o23-playground-node-end-body-padding, 4px 0 2px 0)`
};
