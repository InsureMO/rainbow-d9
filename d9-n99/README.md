...
| VITE_DEFEND_CSP_NO_UNSAFE_EVAL           | `false`            | Y        | Defend `CSP` without `unsafe-eval`. If `CSP` is turned on and `unsafe-eval` is not allowed, set this to `true`.                                                                                                                                                                                               |
...
|---------------------------------|---------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `data-fix-bottom-button-bar`    | `Page`                          | Fix the bottom button bar. Needs to be used together with `data-fix-bottom`.                                                                                                |
...
| `data-fix-title`	               | `Box`                           | Fix the title.                                                                                                                                                              |
...
| `data-fix-bottom`               | `Button Bar`                    | Fix the bar at page bottom. Needs to be used together with `data-fix-bottom-button-bar`.                                                                                    |
