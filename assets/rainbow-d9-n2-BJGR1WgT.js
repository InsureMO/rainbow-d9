...
import { a as color, M as MaskedNumber, e as MaskedDate, g as MaskedFunction, j as MaskedPattern, k as MaskedRange, p as MaskedRegExp, q as MaskedDynamic } from "./vendor-C5T4eKyW.js";
import { R as React, r as reactExports, q as qe, W as We, u as useIMask, a as reactDomExports } from "./react-base-DlVx06xe.js";
import { c as createLogger, V as VUtils, P as PPUtils, r as registerWidget, a as useThrottler, u as useRootEventBus, M as MUtils, N as NUtils, d as Wrapper, e as useForceUpdate, f as MBUtils, b as useWrapperEventBus, W as WrapperEventTypes, g as useCreateEventBus, h as PROPERTY_PATH_ME, i as useDefaultAttributeValues, j as useAttributesWatch, R as RootEventTypes } from "./rainbow-d9-n1-djqxkgqU.js";
    ...
    return async (prefix, clipped, models, callback) => {
      return new Promise((resolve) => {
        if (callback == null) {
          ...
          fire && fire(GlobalEventTypes.CUSTOM_EVENT, `${prefix}:${clipped ?? ""}`, prefix, clipped, models, async () => {
            await callback();
            resolve();
          });
        }
...
`;
const ATableBodyCellExpandArea = qe.div.attrs(({ rowIndex, columnsCount, expanded }) => {
  return {
