import { R as React, b as reactIsExports, r as reactExports, m } from "./react-TxEOKHxf.js";
import { s as stylis_min, u as unitlessKeys, i as isPropValid } from "./emotion--D3psyId.js";
...
function ae(e2) {
  var t2, n2, r2, o2, s2 = void 0 === e2 ? w : e2, i2 = s2.options, a2 = void 0 === i2 ? w : i2, c2 = s2.plugins, u2 = void 0 === c2 ? S : c2, l2 = new stylis_min(a2), d2 = [], p2 = /* @__PURE__ */ function(e3) {
    function t3(t4) {
      if (t4)
        try {
          e3(t4 + "}");
