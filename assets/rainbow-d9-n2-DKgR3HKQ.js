...
import { a as color, M as MaskedNumber, e as MaskedDate, g as MaskedFunction, j as MaskedPattern, k as MaskedRange, p as MaskedRegExp, q as MaskedDynamic } from "./vendor-CcVuGFYP.js";
import { R as React, r as reactExports, d as dt, m as mt, u as useIMask, a as reactDomExports, Y as Ye } from "./react-base-MUslN2f0.js";
import { c as createLogger, V as VUtils, P as PPUtils, r as registerWidget, a as useThrottler, u as useRootEventBus, M as MUtils, N as NUtils, d as Wrapper, e as useForceUpdate, f as MBUtils, b as useWrapperEventBus, W as WrapperEventTypes, g as useCreateEventBus, h as PROPERTY_PATH_ME, i as useDefaultAttributeValues, j as useAttributesWatch, R as RootEventTypes } from "./rainbow-d9-n1-6kBM3eUf.js";
...
const setCalendarDefaults = (defaults) => {
  DEFAULTS$2.YM_FORMAT = defaults.ymFormat ?? DEFAULTS$2.YM_FORMAT;
  DEFAULTS$2.DATE_FORMAT = defaults.dateFormat ?? DEFAULTS$2.DATE_FORMAT;
  DEFAULTS$2.TIME_FORMAT = defaults.timeFormat ?? DEFAULTS$2.TIME_FORMAT;
  DEFAULTS$2.DATETIME_FORMAT = defaults.datetimeFormat ?? DEFAULTS$2.DATETIME_FORMAT;
  DEFAULTS$2.AUTO_CONFIRM = defaults.autoConfirm ?? DEFAULTS$2.AUTO_CONFIRM;
  DEFAULTS$2.AUTO_CONFIRM_ON_DATE = defaults.autoConfirmOnDate ?? DEFAULTS$2.AUTO_CONFIRM_ON_DATE;
  DEFAULTS$2.USE_CALENDAR_ICON = defaults.useCalendarIcon ?? DEFAULTS$2.USE_CALENDAR_ICON;
};
const getDefaultCalendarYMFormat = () => DEFAULTS$2.YM_FORMAT;
const getDefaultCalendarDateFormat = () => DEFAULTS$2.DATE_FORMAT;
const getDefaultCalendarTimeFormat = () => DEFAULTS$2.TIME_FORMAT;
const getDefaultCalendarDatetimeFormat = () => DEFAULTS$2.DATETIME_FORMAT;
const isCalendarAutoConfirm = () => DEFAULTS$2.AUTO_CONFIRM;
const isCalendarAutoConfirmOnDate = () => DEFAULTS$2.AUTO_CONFIRM_ON_DATE;
const isStickIconUseCalendar = () => DEFAULTS$2.USE_CALENDAR_ICON;
...
const InternalInput = reactExports.forwardRef((props, ref) => {
  ...
  const { ref: inputRef, setUnmaskedValue } = useIMask(maskOptions, {
