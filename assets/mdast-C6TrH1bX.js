import { p as postprocess, a as parse, b as preprocess, n as normalizeIdentifier, d as decodeString, c as decodeNumericCharacterReference, t as toMatters, e as normalizeUri, u as unicodeWhitespace, f as unicodePunctuation } from "./micromark-BTDmxCTo.js";
import { d as decodeNamedCharacterReference, o as ok, l as longestStreak, m as markdownTable, t as trimLines, s as structuredClone, c as ccount } from "./vendor-BVSc12Ax.js";
import { s as stringifyPosition, v as visit, E as EXIT, c as convert, p as pointStart, a as pointEnd, b as position, d as visitParents } from "./unist-Cr9IcGMv.js";
...
function code$1(node2, _, state, info) {
  ...
  if (formatCodeAsIndented(node2, state)) {
    ...
    const value3 = state.indentLines(raw, map);
    exit3();
    return value3;
  }
  const tracker = state.createTracker(info);
...
function trimMarkdownSpaceStart(value2) {
  let index = 0;
  let code2 = value2.charCodeAt(index);
  while (code2 === 9 || code2 === 32) {
    index++;
    code2 = value2.charCodeAt(index);
  }
  return value2.slice(index);
}
