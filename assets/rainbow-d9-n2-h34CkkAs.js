...
const SortAsc = (props) => {
  return React.createElement(
    "svg",
    { ...props, "data-icon": "sort-asc", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
    React.createElement("path", { d: "M4 16L13 16", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    React.createElement("path", { opacity: "0.7", d: "M6 11H13", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    React.createElement("path", { opacity: "0.3", d: "M8 6L13 6", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    React.createElement("path", { d: "M17 4L17 20L20 16", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })
  );
};
const SortDesc = (props) => {
  return React.createElement(
    "svg",
    { ...props, "data-icon": "sort-desc", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
    React.createElement("path", { d: "M4 8H13", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    React.createElement("path", { opacity: "0.7", d: "M6 13H13", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    React.createElement("path", { opacity: "0.4", d: "M8 18H13", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    React.createElement("path", { d: "M17 20V4L20 8", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })
  );
};
const SortNone = (props) => {
  return React.createElement(
    "svg",
    { ...props, "data-icon": "sort-none", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
    React.createElement("path", { opacity: "0.5", d: "M4 17H11", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    React.createElement("path", { opacity: "0.5", d: "M4 12L11 12", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    React.createElement("path", { opacity: "0.5", d: "M4 7L11 7", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    React.createElement("path", { d: "M17 4L17 20M17 4L14 8M17 4L20 8M17 20L20 16M17 20L14 16", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })
  );
};
...
const setCalendarDefaults = (defaults) => {
  DEFAULTS$3.YM_FORMAT = defaults.ymFormat ?? DEFAULTS$3.YM_FORMAT;
  DEFAULTS$3.DATE_FORMAT = defaults.dateFormat ?? DEFAULTS$3.DATE_FORMAT;
  DEFAULTS$3.TIME_FORMAT = defaults.timeFormat ?? DEFAULTS$3.TIME_FORMAT;
  DEFAULTS$3.DATETIME_FORMAT = defaults.datetimeFormat ?? DEFAULTS$3.DATETIME_FORMAT;
  DEFAULTS$3.AUTO_CONFIRM = defaults.autoConfirm ?? DEFAULTS$3.AUTO_CONFIRM;
  DEFAULTS$3.AUTO_CONFIRM_ON_DATE = defaults.autoConfirmOnDate ?? DEFAULTS$3.AUTO_CONFIRM_ON_DATE;
  DEFAULTS$3.USE_CALENDAR_ICON = defaults.useCalendarIcon ?? DEFAULTS$3.USE_CALENDAR_ICON;
};
const getDefaultCalendarYMFormat = () => DEFAULTS$3.YM_FORMAT;
const getDefaultCalendarDateFormat = () => DEFAULTS$3.DATE_FORMAT;
const getDefaultCalendarTimeFormat = () => DEFAULTS$3.TIME_FORMAT;
const getDefaultCalendarDatetimeFormat = () => DEFAULTS$3.DATETIME_FORMAT;
const isCalendarAutoConfirm = () => DEFAULTS$3.AUTO_CONFIRM;
const isCalendarAutoConfirmOnDate = () => DEFAULTS$3.AUTO_CONFIRM_ON_DATE;
const isStickIconUseCalendar = () => DEFAULTS$3.USE_CALENDAR_ICON;
...
const AButton = dt.button.attrs(({ id, hasOneLeadOrTail, [DOM_KEY_WIDGET]: dataW }) => {
  return {
...
`;
const LeadDecorator$2 = dt(Decorator$2).attrs({ [DOM_KEY_WIDGET]: "d9-deco-lead" })`
`;
const TailDecorator$2 = dt(Decorator$2).attrs({ [DOM_KEY_WIDGET]: "d9-deco-tail" })`
`;
...
const AlertContainer = dt.div.attrs(({ visible }) => {
  return {
...
`;
const AlertDialog = dt.div.attrs(({ visible }) => {
  return {
    ...
    transition: all ${CssVars.TRANSITION_DURATION} ${CssVars.TRANSITION_TIMING_FUNCTION};
`;
const AlertBody = dt.div.attrs({ [DOM_KEY_WIDGET]: "alert-body", "data-v-scroll": "" })`
    flex-grow: 1;
...
`;
const AlertFooter = dt.div.attrs({ [DOM_KEY_WIDGET]: "alert-footer" })`
    display: flex;
    justify-content: flex-end;
`;
const AlertLabel = dt.span.attrs({ [DOM_KEY_WIDGET]: "alert-label" })`
    font-variant: ${CssVars.FONT_VARIANT};
...
const DialogContainer = dt.div.attrs(({ visible }) => {
  return {
...
`;
const DialogWrapper = dt.div.attrs({ [DOM_KEY_WIDGET]: "dialog-wrapper" })`
    ...
    box-shadow: ${CssVars.DIALOG_SHADOW};
`;
const DialogHeader = dt.div.attrs({ [DOM_KEY_WIDGET]: "dialog-header" })`
    display: flex;
    position: relative;
    ...
    align-items: center;
`;
const DialogTitle = dt.div.attrs({ [DOM_KEY_WIDGET]: "dialog-title" })`
    font-family: ${CssVars.DIALOG_HEADER_FONT_FAMILY};
    font-size: ${CssVars.DIALOG_HEADER_FONT_SIZE};
    text-transform: uppercase;
`;
const DialogBody = dt.div.attrs({ [DOM_KEY_WIDGET]: "dialog-body" })`
    flex-grow: 1;
    min-height: ${CssVars.DIALOG_BODY_MIN_HEIGHT};
`;
const DialogFooter = dt.div.attrs({ [DOM_KEY_WIDGET]: "dialog-footer" })`
    display: flex;
    align-items: center;
    justify-content: flex-end;
...
`;
const DialogLabel = dt.span.attrs({ [DOM_KEY_WIDGET]: "dialog-label" })`
    font-variant: ${CssVars.FONT_VARIANT};
...
const YesNoDialog = () => {
  ...
  reactExports.useEffect(() => {
    const show = (question, onYes, onNo) => {
      if (fire != null) {
        fire(GlobalEventTypes.SHOW_DIALOG, React.createElement(YesNoContent, { question, onYes, onNo }));
      }
    };
...
`;
const RemoteRequestContainer = dt.div.attrs(({ visible }) => {
  return {
    ...
    > svg {
        height: 40px;
        width: 40px;
        animation: 2s linear infinite ${SpinnerKeyFrames$1};
...
const RemoteRequest = (props) => {
  ...
  reactExports.useEffect(() => {
    const on401 = () => {
      if (fire != null) {
        fire(GlobalEventTypes.SHOW_ALERT, React.createElement(AlertLabel, null, "Unauthorized."), () => {
          clearAccount();
          doOn401();
        });
      }
    ...
    const on403 = () => {
      if (fire != null) {
        fire(GlobalEventTypes.SHOW_ALERT, React.createElement(AlertLabel, null, "Access denied."), () => {
          doOn403();
        });
      }
    };
    const onOtherError = () => {
      if (fire != null) {
        fire(GlobalEventTypes.SHOW_ALERT, React.createElement(AlertLabel, null, "Unpredicted error occurred, contact your administrator for more details."));
      }
    };
...
const useCollapseFixedThing = (options) => {
  ...
  reactExports.useEffect(() => {
    ...
    const collapse = (event) => {
      if ((containerRef == null ? void 0 : containerRef.current) != null && notInMe(containerRef.current, event.target) && ((popupRef == null ? void 0 : popupRef.current) == null || notInMe(popupRef.current, event.target))) {
        hide();
      }
    };
    ...
    const collapseOnBlur = (event) => {
      setTimeout(() => {
        const node = document.querySelector(":focus") ?? event.relatedTarget;
        if (node != null && (containerRef == null ? void 0 : containerRef.current) != null && notInMe(containerRef.current, node) && ((popupRef == null ? void 0 : popupRef.current) == null || notInMe(popupRef.current, node))) {
          hide();
        }
      }, 10);
    };
...
const TipContainer = dt.div.attrs(({ visible, minWidth, maxWidth, maxHeight, tag, top, left }) => {
  ...
  return {
    ...
    overflow: hidden;
`;
const TipHeader = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-tip-header" })`
    display: flex;
    position: relative;
    align-items: center;
...
`;
const TipTitle = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-tip-header-title" })`
    display: flex;
    position: relative;
    align-items: center;
    flex-grow: 1;
...
`;
const TipBody = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-tip-body" })`
    display: flex;
    position: relative;
    padding: 0 ${CssVars.TIP_BODY_PADDING};
`;
const TipLabel = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-tip-label" })`
    display: flex;
    position: relative;
    align-items: center;
    min-height: ${CssVars.INPUT_HEIGHT};
...
(function(GlobalEventPrefix2) {
  ...
  GlobalEventPrefix2["RIBS_ELEMENT_EXPANDED"] = "ribs-element-expanded";
  GlobalEventPrefix2["RIBS_ELEMENT_COLLAPSED"] = "ribs-element-collapsed";
...
const useSimpleCustomGlobalEvent = () => {
  const { fire } = useGlobalEventBus();
  const [func] = reactExports.useState(() => {
    return async (prefix, clipped, models, callback) => {
      return new Promise((resolve) => {
        if (callback == null) {
          if (fire != null) {
          ...
          if (fire != null) {
            fire(GlobalEventTypes.CUSTOM_EVENT, `${prefix}:${clipped ?? ""}`, prefix, clipped, models, async () => {
              await callback();
              resolve();
            });
          }
...
const ACaption = dt.span.attrs(({ id, [DOM_KEY_WIDGET]: dataW }) => {
  return {
...
`;
const LeadDecorator$1 = dt(Decorator$1).attrs({ [DOM_KEY_WIDGET]: "d9-deco-lead" })`
`;
const TailDecorator$1 = dt(Decorator$1).attrs({ [DOM_KEY_WIDGET]: "d9-deco-tail" })`
`;
...
const ACheckbox = dt.div.attrs(({ id }) => {
  return {
...
const AnInput = dt.input.attrs(({ id, autoSelect, onFocus }) => {
  if (!autoSelect) {
    return {
...
const InternalInput = reactExports.forwardRef((props, ref) => {
  ...
  const { ref: inputRef, setUnmaskedValue, setTypedValue } = useIMask(maskOptions, {
  ...
  const displayValue = hasMask ? void 0 : compositionRef.current.ing ? compositionRef.current.text : stringifyInputValue({ $model, $pp, value: valueRef.current.value });
  ...
  const onCompositionEnd = async (event) => {
  ...
  return React.createElement(AnInput, { ...rest, autoSelect, disabled: $disabled, "data-disabled": $disabled, "data-visible": $visible, value: displayValue, onChange, onCompositionStart, onCompositionEnd, id: PPUtils.asId(PPUtils.absolute($p2r, $pp), props.id), ref: inputRef });
});
const Input = reactExports.forwardRef((props, ref) => {
  const { placeholder, ...rest } = props;
  const i18nPlaceholder = usePlaceholder(placeholder);
  return React.createElement(InternalInput, { ...rest, placeholder: i18nPlaceholder, ref });
});
const NumberInput = reactExports.forwardRef((props, ref) => {
  ...
  return React.createElement(InternalInput, { ...rest, placeholder: i18nPlaceholder, mask, "data-number": true, valueToNumber: true, ref });
});
const PasswordInput = reactExports.forwardRef((props, ref) => {
  const { placeholder, ...rest } = props;
  const i18nPlaceholder = usePlaceholder(placeholder);
  return React.createElement(InternalInput, { ...rest, placeholder: i18nPlaceholder, type: "password", valueToNumber: false, ref });
});
...
const DecorateInputContainer = dt.div.attrs(({ id }) => {
  return {
...
`;
const LeadDecorator = dt(Decorator).attrs({ [DOM_KEY_WIDGET]: "d9-deco-lead" })`
    &:first-child {
        border-top-left-radius: ${CssVars.BORDER_RADIUS};
        border-bottom-left-radius: ${CssVars.BORDER_RADIUS};
    }
`;
const TailDecorator = dt(Decorator).attrs({ [DOM_KEY_WIDGET]: "d9-deco-tail" })`
    &:last-child {
        border-top-right-radius: ${CssVars.BORDER_RADIUS};
        border-bottom-right-radius: ${CssVars.BORDER_RADIUS};
    }
`;
const Placeholder = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-deco-input-placeholder" })`
    display: block;
    position: absolute;
    top: var(--top, 0);
    left: var(--left, 0);
...
const useComposition = () => {
  ...
  const onCompositionStart = () => {
    var _a;
    (_a = inputRef.current) == null ? void 0 : _a.setAttribute("data-composition-ing", "true");
  };
  const onCompositionEnd = () => {
    var _a;
    (_a = inputRef.current) == null ? void 0 : _a.setAttribute("data-composition-ing", "false");
  };
...
const DecorateInput = reactExports.forwardRef((props, ref) => {
  ...
  return React.createElement(
    ...
    React.createElement(Input, { ...rest, onCompositionStart, onCompositionEnd, ref: inputRef })
  );
});
const DecorateNumberInput = reactExports.forwardRef((props, ref) => {
  ...
  return React.createElement(
    Decorate,
    { ...deviceTags, ...decorateAttrs, placeholder: computePlaceholder(), leads, tails, className, style, id: PPUtils.asId(PPUtils.absolute($p2r, props.$pp), props.id), ref: decorateRef },
    React.createElement(NumberInput, { ...rest, onCompositionStart, onCompositionEnd, ref: inputRef })
  );
});
const DecoratePasswordInput = reactExports.forwardRef((props, ref) => {
  ...
  return React.createElement(
    ...
    React.createElement(PasswordInput, { ...rest, onCompositionStart, onCompositionEnd, ref: inputRef })
  );
});
...
const ATree = dt.div.attrs(({ id, [DOM_KEY_WIDGET]: dataW, height }) => {
  return {
...
`;
const TreeSearchInput = dt(UnwrappedDecorateInput)`
    min-height: ${CssVars.INPUT_HEIGHT};
    background-color: ${CssVars.BACKGROUND_COLOR};
    border-top-left-radius: ${CssVars.BORDER_RADIUS};
    border-top-right-radius: ${CssVars.BORDER_RADIUS};
...
`;
const TreeContentContainer = dt.div.attrs({
  ...
  "data-h-scroll": ""
    ...
    overflow: auto;
`;
const TreeNodeWrapper = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-tree-node-wrapper" })`
    display: flex;
    position: relative;
    flex-direction: column;
...
`;
const TreeNodeContainer = dt(TreeNode$1).attrs({ [DOM_KEY_WIDGET]: "d9-tree-node-container" })`
    cursor: pointer;
...
`;
const TreeNodeOperators = dt.div.attrs(({ top, right }) => {
  return {
...
`;
const TreeNodeContent = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-tree-node-content" })`
    display: flex;
    position: relative;
    flex-grow: 1;
    align-items: center;
...
`;
const TreeNodeToggle = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-tree-node-toggle" })`
...
`;
const TreeNodeIndex = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-tree-node-index" })`
    display: flex;
    position: relative;
    align-items: center;
    margin-right: 8px;
...
`;
const TreeNodeLabel = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-tree-node-label" })`
    display: flex;
    position: relative;
    align-items: center;
    align-self: stretch;
...
`;
const TreeHoverShade = dt.div.attrs(({ top, height, visible }) => {
  return {
...
const TreeNodeRenderer = (props) => {
  ...
  if (checkable) {
    ...
    onCheckValueChanged = async (value) => {
      ...
      if (fire != null) {
        fire(TreeNodeEventTypes.SWITCH_MY_CHECKED, node.marker, value);
      }
    };
  }
...
const ChildTreeNodes = (props) => {
  ...
  reactExports.useEffect(() => {
    ...
    const scrollToAdded = (childNode) => {
      if (fire != null) {
        fire(TreeNodeEventTypes.SWITCH_MY_EXPAND, node.marker, true, childNode == null ? void 0 : childNode.marker);
      }
    };
...
const DropdownContainer = dt.div.attrs(({ id, active, atBottom }) => {
  return {
    [DOM_ID_WIDGET]: id,
...
`;
const DropdownLabel = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-dropdown-label" })`
    flex-grow: 1;
    display: flex;
    align-items: center;
    color: ${CssVars.FONT_COLOR};
...
`;
const DropdownStickCaret = dt(CaretDown).attrs({ [DOM_KEY_WIDGET]: "d9-dropdown-caret" })`
    height: calc(${CssVars.INPUT_HEIGHT} * 2 / 5);
    fill: ${CssVars.FONT_COLOR};
    transition: all ${CssVars.TRANSITION_DURATION} ${CssVars.TRANSITION_TIMING_FUNCTION};
`;
const DropdownStickClear = dt(Times).attrs({ [DOM_KEY_WIDGET]: "d9-dropdown-clear" })`
    height: calc(${CssVars.INPUT_HEIGHT} * 2 / 5);
    fill: ${CssVars.FONT_COLOR};
    transition: all ${CssVars.TRANSITION_DURATION} ${CssVars.TRANSITION_TIMING_FUNCTION};
`;
const DropdownStickContainer = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-dropdown-stick" })`
    display: flex;
    position: relative;
    align-items: center;
    justify-content: center;
    ...
    if (clearable) {
      if (!fix) {
        return React.createElement(
          ...
          { "data-clear": true, "data-disabled": disabled, "data-fix": false, onClick: onClearClicked, ...rest },
        ...
        return React.createElement(
          ...
          React.createElement(
            DropdownStickContainer,
            { "data-clear": true, "data-disabled": disabled, "data-fix": true, "data-stick-index": 1, "data-view-on-hover-only": !DropdownDefaults.DEFAULTS.FIX_CLEAR_STICK, onClick: onClearClicked, ...rest },
            React.createElement(DropdownStickClear, null)
          ),
          React.createElement(DropdownStickContainer, { "data-disabled": disabled, "data-fix": true, "data-stick-index": 2, ...rest }, icon == null ? React.createElement(DropdownStickCaret, null) : icon)
        );
      }
    } else {
      return React.createElement(DropdownStickContainer, { "data-disabled": disabled, "data-fix": fix, ...rest }, icon == null ? React.createElement(DropdownStickCaret, null) : icon);
    }
  } else {
    return React.createElement(DropdownStickContainer, { "data-disabled": disabled, "data-fix": fix, ...rest }, icon == null ? React.createElement(DropdownStickCaret, null) : icon);
  }
};
const DropdownPopupContainer = dt.div.attrs(({ atBottom, shown, vScroll, hScroll, top, left, height, minWidth, maxWidth, minHeight, maxHeight }) => {
  return {
...
const DropdownPopup = reactExports.forwardRef((props, ref) => {
  const { shown, vScroll, hScroll, onKeyDown, children, ...state } = props;
  if (DropdownDefaults.DEFAULTS.findPortalCarrier == null) {
    ...
    return reactDomExports.createPortal(React.createElement(DropdownPopupContainer, { shown, vScroll, hScroll, onKeyDown, ...state, ref }, children), DropdownDefaults.DEFAULTS.findPortalCarrier());
  }
});
...
const useExternalFilteringDropdown = (externalFilterHandle) => {
  const globalHandlers = useGlobalHandlers();
  const { fire: fireWrapper } = useWrapperEventBus();
  const { replace, clear } = useThrottler();
  const externalFiltering = reactExports.useRef(false);
  const forceUpdate = useForceUpdate();
  const filterChanged = externalFilterHandle == null ? void 0 : async (filter, timing) => {
...
const useFilterableDropdownOptions = (props) => {
  ...
  const fixFilterExists = DropdownDefaults.DEFAULTS.FIX_FILTER && (VUtils.isNotBlank(filter) || compositionRef.current.ing && VUtils.isNotBlank(compositionRef.current.text));
...
`;
const OptionFilter = dt.div.attrs(({ "data-w": widgetKey, active, atBottom, top, left, height }) => {
...
const computeDropdownTreePopupHeight = (allOptions, filter) => {
  const allOptionCount = (() => {
    const countMeAndChildren = (option) => {
      return 1 + (option.children ?? []).reduce((count, option2) => {
        return count + countMeAndChildren(option2);
      }, 0);
    };
...
const AButtonBar = dt.div.attrs(({ id, [DOM_KEY_WIDGET]: dataW }) => {
  return {
...
const ButtonBar = reactExports.forwardRef((props, ref) => {
  ...
  const { $p2r, $avs: { $disabled, $visible } } = $wrapped;
  return React.createElement(AButtonBar, { ...rest, "data-disabled": $disabled, "data-visible": $visible, id: PPUtils.asId(PPUtils.absolute($p2r, props.$pp), props.id), "data-alignment": alignment, ref }, children);
});
registerWidget({ key: "ButtonBar", JSX: ButtonBar, container: true, array: false });
const Option$2 = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-dropdown-option" })`
    display: flex;
    position: relative;
    align-items: center;
    font-family: ${CssVars.FONT_FAMILY};
...
const Dropdown = reactExports.forwardRef((props, ref) => {
  ...
  return React.createElement(
    ...
    React.createElement(DropdownStick, { valueAssigned: selected, clearable, clear: onClearClicked, disabled: $disabled, fix: DropdownDefaults.DEFAULTS.FIX_DROPDOWN_STICK }),
    isDropdownPopupActive(popupState.active) ? React.createElement(
      ...
      React.createElement(
        OptionFilter,
        { ...popupState, active: filterActive, "data-w": "d9-dropdown-option-filter" },
        React.createElement("span", null, "?:"),
        React.createElement("span", null, externalFilteringNow ? React.createElement(Spinner, null) : React.createElement(Search, null)),
        React.createElement("input", { value: filter, onChange: onFilterChanged, onKeyUp, onCompositionStart, onCompositionEnd, ref: filterInputRef })
      ),
...
const MultiDropdownContainer = dt(DropdownContainer)`
    align-self: start;
    flex-wrap: wrap;
    height: unset;
    min-height: ${CssVars.INPUT_HEIGHT};
...
`;
const MultiDropdownLabel = dt(DropdownLabel)`
    flex-grow: unset;
    border: ${CssVars.BORDER};
    border-radius: ${CssVars.BORDER_RADIUS};
    color: ${CssVars.FONT_COLOR};
...
`;
const MultiDropdownStick = dt(DropdownStick)`
    position: absolute;
...
`;
const MultiOption = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-multi-dropdown-option" })`
    display: flex;
    position: relative;
    align-items: center;
    padding: calc(${CssVars.INPUT_HEIGHT} / 8) ${CssVars.INPUT_INDENT};
...
const MultiDropdown = reactExports.forwardRef((props, ref) => {
  ...
  const globalHandlers = useGlobalHandlers();
  const { filterChanged: externalFilterChanged, externalFilteringNow } = useExternalFilteringDropdown(filterChanged);
  const { askOptions, displayOptions, filterInputRef, filter, onFilterChanged, active: filterActive, containerRef, popupState, popupHeight, popupRef, popupShown, repaintPopup, onClicked, onFocused, onKeyUp, onAnyInputEvent, onCompositionStart, onCompositionEnd } = useFilterableDropdownOptions({ ...props, filterChanged: externalFilterChanged });
  const forceUpdate = useForceUpdate();
  useDualRefs(containerRef, ref);
  useTip({ ref: containerRef, ...buildTip({ tip, root: $root, model: $model }) });
  ...
  return React.createElement(
    ...
    { active: popupState.active, atBottom: popupState.atBottom, role: "input", tabIndex: 0, ...rest, "data-w": "d9-multi-dropdown", "data-disabled": $disabled, "data-visible": $visible, "data-clearable": clearable, "data-dual-sticks": selected && clearable && (DropdownDefaults.DEFAULTS.FIX_MULTI_DROPDOWN_STICK ?? DropdownDefaults.DEFAULTS.FIX_STICK), onFocus: onFocused, onClick: onClicked, onKeyDown: onAnyInputEvent, id: PPUtils.asId(PPUtils.absolute($p2r, $pp), props.id), ref: containerRef },
    values.map((value) => {
      var _a;
      const v = `${value}`;
      return React.createElement(
    ...
    React.createElement(MultiDropdownStick, { valueAssigned: selected, clearable, clear: onClearClicked, disabled: $disabled, fix: DropdownDefaults.DEFAULTS.FIX_MULTI_DROPDOWN_STICK }),
    isDropdownPopupActive(popupState.active) ? React.createElement(
      DropdownPopup,
      { ...popupState, minHeight: popupHeight, shown: popupShown && popupState.active === DropdownPopupStateActive.ACTIVE, ...deviceTags, vScroll: true, ref: popupRef },
      React.createElement(
        OptionFilter,
        { ...popupState, active: filterActive, "data-w": "d9-multi-dropdown-option-filter" },
        React.createElement("span", null, "?:"),
        React.createElement("span", null, externalFilteringNow ? React.createElement(Spinner, null) : React.createElement(Search, null)),
        React.createElement("input", { value: filter, onChange: onFilterChanged, onKeyUp, onCompositionStart, onCompositionEnd, ref: filterInputRef })
      ),
...
const PopupContainer = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-popup-wrapper" })`
    display: flex;
    position: relative;
    flex-direction: column;
    background-color: ${CssVars.BACKGROUND_COLOR};
    ...
    font-size: ${CssVars.FONT_SIZE};
`;
const LeftCaret = dt(CaretLeft)`
    height: ${CssVars.FONT_SIZE};
    width: calc(${CssVars.FONT_SIZE} + 2px);
    fill: ${CssVars.FONT_COLOR};
`;
const RightCaret = dt(CaretRight)`
    height: ${CssVars.FONT_SIZE};
    width: calc(${CssVars.FONT_SIZE} + 2px);
    fill: ${CssVars.FONT_COLOR};
`;
...
const DatePickerContainer = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-date-picker" })`
    display: grid;
    grid-template-columns: 1fr auto;
    cursor: default;
`;
const DatePickerShortcut = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-date-picker-shortcuts" })`
    display: flex;
    flex-direction: column;
    grid-row: span 2;
    border-right: ${CssVars.BORDER};
`;
const DatePickerShortcutButton = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-date-picker-shortcut-button" })`
    display: flex;
    align-items: center;
...
`;
const DatePickerHeader = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-date-picker-header" })`
    display: flex;
    align-items: center;
    ...
    padding: 0 ${CssVars.CALENDAR_GUTTER_SIZE};
`;
const DatePickerHeaderYearMonth = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-date-picker-header-ym" })`
    font-weight: ${CssVars.FONT_BOLD};
    font-variant: ${CssVars.FONT_VARIANT};
`;
const DatePickerHeaderOperators = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-date-picker-header-operators" })`
    display: flex;
    align-items: center;
`;
const DatePickerHeaderButton = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-date-picker-header-button" })`
    display: flex;
    align-items: center;
    justify-content: center;
    font-weight: ${CssVars.FONT_BOLD};
...
`;
const DatePickerHeaderTodayButton = dt(DatePickerHeaderButton)`
    transform: scale(0.8);
    transform-origin: right;
    padding: 2px 6px;
    font-variant: ${CssVars.FONT_VARIANT};
`;
const DatePickerHeaderMonthChangeButton = dt(DatePickerHeaderButton)`
    height: 20px;
    width: 24px;
`;
const DatePickerBody = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-date-picker-body" })`
    display: grid;
...
`;
const DatePickerBodyHeaderCell = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-date-picker-body-header-cell" })`
    display: flex;
    align-items: center;
    justify-content: center;
    position: relative;
...
`;
const DatePickerBodyDateCell = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-date-picker-body-date-cell" })`
    display: flex;
    align-items: center;
    justify-content: center;
    position: relative;
...
const PopupHeaderContainer = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-popup-header" })`
    display: flex;
    align-items: center;
    border-bottom: ${CssVars.BORDER};
    ...
    cursor: default;
`;
const PopupHeaderDateLabel = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-popup-date-label" })`
    font-size: 0.8em;
    font-weight: ${CssVars.FONT_BOLD};
    font-variant: ${CssVars.FONT_VARIANT};
    margin-right: 0.5em;
`;
const PopupHeaderTimeLabel = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-popup-header-time-label" })`
    font-size: 0.8em;
    font-weight: ${CssVars.FONT_BOLD};
    font-variant: ${CssVars.FONT_VARIANT};
`;
const PopupHeaderPlaceholder = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-popup-header-placeholder" })`
    flex-grow: 1;
`;
const PopupHeaderTimeButton = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-popup-header-time-button" })`
    display: flex;
    position: relative;
    align-items: center;
    justify-content: center;
...
`;
const DateIcon = dt(Date$1)`
    height: ${CssVars.FONT_SIZE};
    width: calc(${CssVars.FONT_SIZE} + 2px);
    fill: ${CssVars.FONT_COLOR};
`;
const TimeIcon = dt(Time)`
    height: ${CssVars.FONT_SIZE};
    width: calc(${CssVars.FONT_SIZE} + 2px);
    fill: ${CssVars.FONT_COLOR};
`;
const BackIcon = dt(Back)`
    height: ${CssVars.FONT_SIZE};
    width: calc(${CssVars.FONT_SIZE} + 2px);
    fill: ${CssVars.FONT_COLOR};
`;
...
const TimePickerContainer = dt.div.attrs(({ columns }) => {
  return {
    ...
    cursor: default;
`;
const TimePickerLabel = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-time-picker-label" })`
    display: flex;
    align-items: center;
    font-variant: ${CssVars.FONT_VARIANT};
    font-weight: ${CssVars.FONT_BOLD}
`;
const TimePickerSelector = dt.div.attrs({
  ...
  "data-v-scroll": ""
    ...
    overflow-y: scroll;
`;
const TimePickerSelectorOption = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-time-picker-selector-option" })`
    display: flex;
    position: relative;
    align-items: center;
    min-height: ${CssVars.INPUT_HEIGHT};
...
const YearMonthPickerContainer = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-ym-picker" })`
    display: grid;
    position: relative;
    ...
    cursor: default;
`;
const YearMonthPickerLabel = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-ym-picker-label" })`
    display: flex;
    align-items: center;
    font-variant: ${CssVars.FONT_VARIANT};
    font-weight: ${CssVars.FONT_BOLD};
...
`;
const YearSelector = dt.div.attrs({
  ...
  "data-v-scroll": ""
    ...
    overflow-y: scroll;
`;
const YearSelectorOption = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-ym-picker-year-selector-option" })`
    display: flex;
    position: relative;
    align-items: center;
    min-height: ${CssVars.INPUT_HEIGHT};
...
`;
const MonthSelector = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-ym-picker-month-selector" })`
    display: grid;
    grid-template-columns: 1fr 1fr 1fr;
    grid-column-gap: ${CssVars.CALENDAR_GUTTER_SIZE};
    grid-row-gap: ${CssVars.CALENDAR_GUTTER_SIZE};
`;
const MonthSelectorOption = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-calendar-ym-picker-month-selector-option" })`
    display: flex;
    position: relative;
    align-items: center;
    justify-content: center;
...
const YearMonthPicker = (props) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      null,
      React.createElement(IntlLabel, { keys: ["calendar", "year"], value: "Year" })
    ),
    React.createElement(
      YearMonthPickerLabel,
      null,
      React.createElement(IntlLabel, { keys: ["calendar", "month"], value: "Month" })
    ),
...
const DropdownStickCalendar = dt(Date$1).attrs({ [DOM_KEY_WIDGET]: "d9-dropdown-caret" })`
    height: calc(${CssVars.INPUT_HEIGHT} * 2 / 5);
    fill: ${CssVars.FONT_COLOR};
    transition: all ${CssVars.TRANSITION_DURATION} ${CssVars.TRANSITION_TIMING_FUNCTION};
`;
const Picker = reactExports.forwardRef((props, ref) => {
  ...
  return React.createElement(
    ...
    React.createElement(DropdownStick, { valueAssigned, clearable, clear: onClearClicked, disabled: $disabled, icon: useCalendarIcon ? React.createElement(DropdownStickCalendar, null) : void 0, fix: DropdownDefaults.DEFAULTS.FIX_CALENDAR_STICK }),
...
const AFormCell = dt.div.attrs(({ id }) => {
  return {
...
`;
const FormCellInvalidMessage = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-form-cell-invalid-msg" })`
    display: flex;
    position: relative;
    align-items: center;
    font-family: ${CssVars.FONT_FAMILY};
...
const APage = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-page" })`
    display: grid;
    position: relative;
    grid-column: var(--grid-column);
    grid-row: var(--grid-row);
...
`;
const ARibRowHeader = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-rib-row-header" })`
    display: grid;
    position: relative;
    align-items: center;
...
`;
const ARibRowIndex = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-rib-row-index" })`
    display: flex;
    position: relative;
    font-size: 0.8em;
    font-weight: ${CssVars.FONT_BOLD};
`;
const ARibRowHeaderContent = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-rib-row-header-content" })`
    display: block;
    position: relative;
`;
const ARibRowOperators = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-rib-row-operators" })`
    display: flex;
    position: relative;
    align-items: center;
    padding: 0 ${CssVars.BUTTON_INDENT};
...
`;
const ARibRowBody = dt.div.attrs(({ expanded }) => {
  return {
...
`;
const ARibNoDataRow = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-rib-no-data-row" })`
    display: flex;
    position: relative;
    align-items: center;
    font-family: ${CssVars.FONT_FAMILY};
...
`;
const ARibBottomBar = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-rib-bottom-bar" })`
    display: flex;
    position: relative;
    align-items: center;
    justify-content: flex-end;
...
const RibRowExpanderSvg = dt(ArrowDown).attrs({ [DOM_KEY_WIDGET]: "d9-rib-row-header-expander-svg" })`
    height: 70%;
    color: ${CssVars.FONT_COLOR};
    opacity: 0.7;
    transition: transform ${CssVars.TRANSITION_DURATION} ${CssVars.TRANSITION_TIMING_FUNCTION};
...
const SectionStyleExpander = (props) => {
  ...
  return React.createElement(Button, { "$wrapped": $wrapped, ink: ButtonInk.PRIMARY, fill: ButtonFill.PLAIN, leads: [React.createElement(RibRowExpanderSvg, { "data-expanded": expanded })], click: expanded ? collapse : expand, "data-w": "d9-rib-row-operator", "data-role": expanded ? "collapse" : "expand" });
};
const ExpandButton$1 = (props) => {
  ...
  return React.createElement(Button, { "$wrapped": $wrapped, ink: ButtonInk.PRIMARY, fill: ButtonFill.PLAIN, leads: ["$icons.expand"], click: onClick, "data-w": "d9-rib-row-operator", "data-role": "expand" });
};
const CollapseButton$1 = (props) => {
  ...
  return React.createElement(Button, { "$wrapped": $wrapped, ink: ButtonInk.PRIMARY, fill: ButtonFill.PLAIN, leads: ["$icons.collapse"], click: onClick, "data-w": "d9-rib-row-operator", "data-role": "collapse" });
};
const RemoveButton$1 = (props) => {
  ...
  return React.createElement(Button, { "$wrapped": $wrapped, ink: ButtonInk.PRIMARY, fill: ButtonFill.PLAIN, leads: ["$icons.remove"], click: onClick, "data-w": "d9-rib-row-operator", "data-role": "remove" });
};
...
const setRibsDefaults = (defaults) => {
  DEFAULTS$1.USE_SECTION_STYLE_ICONS = defaults.useSectionStyleIcons ?? DEFAULTS$1.USE_SECTION_STYLE_ICONS;
  DEFAULTS$1.SHOW_ROW_INDEX = defaults.showRowIndex ?? DEFAULTS$1.SHOW_ROW_INDEX;
};
const isUseSectionStyleIcons = () => DEFAULTS$1.USE_SECTION_STYLE_ICONS;
const isShowRowIndex = () => DEFAULTS$1.SHOW_ROW_INDEX;
...
const RibRow = (props) => {
  ...
  const customEventCallbackRef = reactExports.useRef({ has: false });
  const { on: onGlobal, off: offGlobal } = useGlobalEventBus();
  ...
  const rowMarker = getElementKey != null ? getElementKey($wrapped.$model, elementIndex) : void 0;
  reactExports.useEffect(() => {
    var _a, _b;
    if (customEventCallbackRef.current.has) {
      customEventCallbackRef.current.has = false;
      (_b = (_a = customEventCallbackRef.current).callback) == null ? void 0 : _b.call(_a);
  ...
  reactExports.useEffect(() => {
    const onCustomEvent = (_, prefix, clipped, _models, callback) => {
      if (clipped !== `${marker ?? ""}-${rowMarker ?? elementIndex}` && clipped !== PPUtils.asId(PPUtils.absolute($wrapped.$p2r, PROPERTY_PATH_ME), void 0)) {
        return;
      }
      switch (prefix) {
  ...
  return React.createElement(
    ARibRow,
    { id: PPUtils.asId(PPUtils.absolute($wrapped.$p2r, PROPERTY_PATH_ME), void 0) },
    React.createElement(
      ARibRowHeader,
      { "data-expanded": expanded, "data-show-row-index": showRowIndex, onClick: onRowClicked, ref: headerRef },
      React.createElement(
        ARibRowIndex,
        null,
        "# ",
...
const isInCellInputBorderOmitted = () => DEFAULTS.OMIT_IN_CELL_INPUT_BORDER;
const isNoneSortFromCycleOmitted = () => DEFAULTS.OMIT_NONE_SORT_FROM_CYCLE;
const ATable = dt.div.attrs(({ id }) => {
  return {
...
`;
const ATableNoDataRow = dt.div.attrs(({ columnsCount }) => {
  return {
...
`;
const ATableContent = dt.div.attrs(({ headerHeight, maxBodyHeight, columnsWidth }) => {
  ...
  return {
    ...
    overflow-y: auto;
`;
const ATableHeaderCell = dt.div.attrs(({ headerHeight, isGrabber, stickyOffset }) => {
  return {
    ...
    style: {
      ...
      "--z-index": VUtils.isNotBlank(stickyOffset[2]) ? 6 : VUtils.isNotBlank(stickyOffset[1]) ? 5 : 4
    }
  };
})`
    display: flex;
...
`;
const ATableBodyRowIndexCell = dt.div.attrs(({ rowIndex, rowSpan }) => {
  return {
...
`;
const ATableBodyCell = dt.div.attrs(({ isGrabber, rowIndex, stickyOffset }) => {
  return {
    ...
    style: {
      ...
      right: stickyOffset[2],
      "--background-color": rowIndex % 2 === 1 ? CssVars.TABLE_ODD_ROW_BACKGROUND_COLOR : CssVars.BACKGROUND_COLOR,
      "--z-index": VUtils.isNotBlank(stickyOffset[2]) ? 3 : VUtils.isNotBlank(stickyOffset[1]) ? 2 : void 0,
...
`;
const ATableRowOperators = dt.div.attrs(({ rowIndex, rowSpan }) => {
  return {
...
`;
const ATableBodyCellExpandArea = dt.div.attrs(({ rowIndex, columnsCount, expanded }) => {
  return {
...
`;
const ATableBottomBar = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-table-bottom-bar" })`
    display: flex;
    position: relative;
    align-items: center;
    justify-content: flex-end;
...
`;
const ATableBottomBarSeparator = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-table-bottom-bar-separator" })`
    display: block;
    position: relative;
    margin: 0 12px;
    border: ${CssVars.BORDER};
...
(function(TableEventTypes2) {
  ...
  TableEventTypes2["REMOVE_ALL_EXPANDING_BEFORE_PAGE_CHANGE"] = "remove-all-expanding-before-page-change";
  ...
  TableEventTypes2["SORT_CHANGED"] = "sort-changed";
...
const APagination = dt.div.attrs(({ id, [DOM_KEY_WIDGET]: dataW }) => {
  return {
...
const Pagination = reactExports.forwardRef((props, ref) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      freeWalk && hasItem ? React.createElement(UnwrappedDropdown, { value: data.pageNumber, options: buildFreeWalkOptions(), clearable: false, "data-free-walk": true, onValueChange: onFreeWalkChanged }) : React.createElement("span", null, data.pageNumber),
      React.createElement(
        "span",
        null,
...
var TableColumnSortType;
(function(TableColumnSortType2) {
  TableColumnSortType2[TableColumnSortType2["NONE"] = 0] = "NONE";
  TableColumnSortType2[TableColumnSortType2["ASC"] = 1] = "ASC";
  TableColumnSortType2[TableColumnSortType2["DESC"] = 2] = "DESC";
})(TableColumnSortType || (TableColumnSortType = {}));
const TableHeader = (props) => {
  const { headers, headerHeight, sort, stickyOffsets, tailGrabberAppended, $wrapped: wrapped } = props;
  const globalHandlers = useGlobalHandlers();
  const { fire: fireWrapper } = useWrapperEventBus();
  ...
  const sortColumn = (key, type) => async () => {
    if (!sortable) {
      return;
    }
    const by = [{ key, type }];
  ...
  return React.createElement(
    ...
    headers.map((header, index) => {
      ...
      const sortType = canSort ? ((_a = sortBy.find((s) => s.key === header.sortKey)) == null ? void 0 : _a.type) ?? TableColumnSortType.NONE : void 0;
      return React.createElement(
        ATableHeaderCell,
        { headerHeight, stickyOffset: stickyOffsets[index + 1], key },
        React.createElement(LabelLike, { "$wrapped": $wrapped, label: header.label }),
        canSort && sortType === TableColumnSortType.ASC ? React.createElement(
          "span",
          { "data-role": "sort", onClick: sortColumn(header.sortKey, TableColumnSortType.DESC) },
          React.createElement(SortAsc, null)
        ) : null,
        canSort && sortType === TableColumnSortType.DESC ? React.createElement(
          "span",
          { "data-role": "sort", onClick: sortColumn(header.sortKey, isNoneSortFromCycleOmitted() ? TableColumnSortType.ASC : TableColumnSortType.NONE) },
          React.createElement(SortDesc, null)
        ) : null,
        canSort && sortType === TableColumnSortType.NONE ? React.createElement(
          "span",
          { "data-role": "sort", onClick: sortColumn(header.sortKey, TableColumnSortType.ASC) },
          React.createElement(SortNone, null)
        ) : null
      );
    }),
...
const TableContent = (props) => {
  ...
  reactExports.useEffect(() => {
    ...
    const firePageableHandle = async (from, to) => {
  ...
  const rows = (() => {
    if (!hasPagination || (pageable == null ? void 0 : pageable.valueChanged) != null) {
      {
        return children;
      }
    }
  ...
  return React.createElement(
    ...
    React.createElement(TableHeader, { headerHeight, headers: props.headers, sort: props.sort, stickyOffsets, tailGrabberAppended, "$wrapped": $wrapped }),
    rows
  );
};
...
const ExpandButton = (props) => {
  ...
  return React.createElement(Button, { "$wrapped": $wrapped, ink: ButtonInk.PRIMARY, fill: ButtonFill.PLAIN, leads: ["$icons.expand"], click: onClick, "data-role": "d9-table-row-operator", "data-r": "expand" });
};
const CollapseButton = (props) => {
  ...
  return React.createElement(Button, { "$wrapped": $wrapped, ink: ButtonInk.PRIMARY, fill: ButtonFill.PLAIN, leads: ["$icons.collapse"], click: onClick, "data-role": "d9-table-row-operator", "data-r": "collapse" });
};
const RemoveButton = (props) => {
  ...
  return React.createElement(Button, { "$wrapped": $wrapped, ink: ButtonInk.PRIMARY, fill: ButtonFill.PLAIN, leads: ["$icons.remove"], click: onClick, "data-role": "d9-table-row-operator", "data-r": "remove" });
};
...
const TableRowOperators = (props) => {
  const { expandable = false, expanded: initExpanded = false, removable = false, rowIndex, rowSpan, $wrapped, omitDefaultRowOperators = false, rowOperators } = props;
  const { on, off, fire } = useTableEventBus();
  const [expanded, setExpanded] = reactExports.useState(initExpanded);
  reactExports.useEffect(() => {
...
const TableRow = (props) => {
    ...
    switch (true) {
      ...
      case !expanded:
        return [
          ...
          React.createElement(ATableBodyCellExpandArea, { rowIndex: elementIndex, columnsCount: expandedAreaColumnCount + 1, expanded, ref: expandAreaRef }, expandCells),
          1,
          1
        ];
      case hideClassicCellsOnExpandable:
        return [
          React.createElement(ATableBodyCellExpandArea, { rowIndex: elementIndex, columnsCount: expandedAreaColumnCount, expanded, ref: expandAreaRef }, expandCells),
          null,
          1,
          1
        ];
  ...
  return React.createElement(
    ...
    classic,
    React.createElement(TableRowOperators, { expandable, expanded, removable, rowIndex: elementIndex, rowSpan: operatorsRowSpan, "$wrapped": $wrapped, omitDefaultRowOperators, rowOperators }),
    expands
  );
};
...
const ABox = dt.div.attrs(({ id, [DOM_KEY_WIDGET]: dataW }) => {
  return {
...
const ASection = dt.div.attrs(({ id, [DOM_KEY_WIDGET]: dataW }) => {
  return {
...
`;
const ASectionHeader = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-section-header" })`
    display: flex;
    position: relative;
    align-items: center;
...
`;
const ASectionTitle = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-section-header-title" })`
    display: flex;
    position: relative;
    align-items: center;
    flex-grow: 1;
    ...
    color: ${CssVars.CAPTION_FONT_COLOR};
`;
const ASectionExpander = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-section-header-expander" })`
    display: flex;
    position: relative;
    align-items: center;
    justify-content: center;
...
`;
const ASectionExpanderSvg = dt(ArrowDown).attrs({ [DOM_KEY_WIDGET]: "d9-section-header-expander-svg" })`
    height: 70%;
    color: ${CssVars.FONT_COLOR};
    opacity: 0.7;
...
`;
const ASectionBody = dt.div.attrs(({ expanded }) => {
  return {
...
const Section = reactExports.forwardRef((props, ref) => {
  const { $wrapped, title, collapsible, collapsed = false, marker, children, ...rest } = props;
  const { $p2r, $avs: { $disabled, $visible } } = $wrapped;
  const headerRef = reactExports.useRef(null);
  const firstRound = reactExports.useRef(true);
  const customEventCallbackRef = reactExports.useRef({ has: false });
  const { on: onGlobal, off: offGlobal } = useGlobalEventBus();
  const [expanded, setExpanded] = reactExports.useState(collapsible !== true || !collapsed);
  const fireCustomEvent = useCustomGlobalEvent();
  reactExports.useEffect(() => {
    var _a, _b;
  ...
  return React.createElement(
    ...
    title != null ? React.createElement(
      ASectionHeader,
      { "data-expanded": expanded, onClick: onHeaderClicked, ref: headerRef },
      React.createElement(
        ASectionTitle,
        null,
...
const useTabActive = (tabIndex, marker, where) => {
  const { on, off } = useTabsEventBus();
  const activeCallbackIndicator = reactExports.useRef({ should: false });
  ...
  reactExports.useEffect(() => {
    ...
    if (activeCallbackIndicator.current.should) {
      ...
      (_b = (_a = activeCallbackIndicator.current).callback) == null ? void 0 : _b.call(_a, where);
      delete activeCallbackIndicator.current.callback;
      forceUpdate();
    }
  }, [activeCallbackIndicator.current.should, where, forceUpdate]);
  reactExports.useEffect(() => {
    const onActiveTab = (givenTabIndex, givenMarker, onActivated) => {
      if (tabIndex === givenTabIndex || marker === givenMarker) {
        if (active === true) {
          onActivated == null ? void 0 : onActivated(where);
        } else {
...
const useTabContentRefresh = (tabIndex, marker, where) => {
  const { on, off } = useTabsEventBus();
  const refreshIndicator = reactExports.useRef({ should: false });
  const forceUpdate = useForceUpdate();
  reactExports.useEffect(() => {
    var _a, _b;
    if (refreshIndicator.current.should) {
      refreshIndicator.current.should = false;
      (_b = (_a = refreshIndicator.current).callback) == null ? void 0 : _b.call(_a, where);
      delete refreshIndicator.current.callback;
      forceUpdate();
    }
  }, [refreshIndicator.current.should, where, forceUpdate]);
  reactExports.useEffect(() => {
    const onActiveTab = (givenTabIndex, givenMarker, onRefreshed) => {
      if (tabIndex === givenTabIndex || marker === givenMarker) {
...
`;
const TabsHeader = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-tabs-header" })`
    display: flex;
    position: relative;
    flex-wrap: wrap;
...
`;
const ATabTitle = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-tab-title" })`
    display: flex;
    position: relative;
    align-items: center;
...
`;
const TabsBody = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-tabs-body" })`
    display: block;
    position: relative;
    ...
    margin-top: -1px;
`;
const ATabBodyVisibility = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-tab-body-visibility" })`
    display: none;
...
`;
const ATabBody = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-tab-body" })`
    display: block;
    position: relative;
`;
...
const TabsController = (props) => {
  ...
  const fireCustomEvent = useCustomGlobalEvent();
  reactExports.useEffect(() => {
    const activeTab = async (options, callback) => {
      ...
      if (def.data != null) {
        ...
        await new Promise((resolve) => {
          fire(TabsEventTypes.REFRESH_TAB_CONTENT, tabIndex, def == null ? void 0 : def.marker, async (where) => {
            if (where === "body") {
              resolve();
            }
          });
      ...
      await new Promise((resolve) => {
        fire(TabsEventTypes.ACTIVE_TAB, tabIndex, def == null ? void 0 : def.marker, async (where) => {
          if (where === "body") {
    ...
    const createOnTabActive = (first) => async (index, marker, onActivated) => {
...
`;
const WizardHeader = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-wizard-header" })`
    display: flex;
    position: relative;
    flex-wrap: wrap;
...
`;
const AWizardStepTitle = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-wizard-step-title" })`
    display: flex;
    position: relative;
    flex-grow: 1;
    align-items: center;
...
`;
const AWizardStepBalloon = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-wizard-step-balloon" })`
    display: flex;
    position: relative;
    align-items: center;
    justify-content: center;
...
`;
const WizardBody = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-wizard-body" })`
    display: block;
    position: relative;
    border-top: ${CssVars.BORDER};
    padding: ${CssVars.SECTION_BODY_PADDING} 0;
    margin-top: -1px;
`;
const AWizardStepBodyVisibility = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-tab-body-visibility" })`
    display: none;
...
`;
const AWizardStepBody = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-wizard-step-body" })`
    display: grid;
    position: relative;
    grid-template-columns: repeat(${CssVars.GRID_COLUMNS}, calc((100% - ${CssVars.GRID_COLUMN_GAP} * (${CssVars.GRID_COLUMNS} - 1)) / ${CssVars.GRID_COLUMNS}));
    grid-column-gap: ${CssVars.GRID_COLUMN_GAP};
...
const WizardController = (props) => {
  ...
  const fireCustomEvent = useCustomGlobalEvent();
  reactExports.useEffect(() => {
    const activeStep = async (options, callback) => {
      ...
      if (def.data != null) {
        ...
        await new Promise((resolve) => {
          fire(WizardEventTypes.REFRESH_STEP_CONTENT, stepIndex, def == null ? void 0 : def.marker, async (where) => {
            if (where === "body") {
              resolve();
            }
          });
      ...
      await new Promise((resolve) => {
        fire(WizardEventTypes.ACTIVE_STEP, stepIndex, def == null ? void 0 : def.marker, reachedIndex, async (where) => {
          if (where === "body") {
            await (callback == null ? void 0 : callback());
            resolve();
          }
    ...
    const createOnStepActive = (first) => async (index, marker, onActivated) => {
...
const useWizardStepActive = (stepIndex, marker, where) => {
  ...
  reactExports.useEffect(() => {
    const onActiveStep = (givenTabIndex, givenMarker, reachedIndex, onActivated) => {
...
const useWizardStepContentRefresh = (tabIndex, marker, where) => {
  const { on, off } = useWizardEventBus();
  const refreshIndicator = reactExports.useRef({ should: false });
  const forceUpdate = useForceUpdate();
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    const onActiveStep = (givenTabIndex, givenMarker, onRefreshed) => {
      if (tabIndex === givenTabIndex || marker === givenMarker) {
        refreshIndicator.current = { should: true, callback: onRefreshed };
        forceUpdate();
      }
...
const ATextarea = dt.textarea.attrs(({ id, autoSelect, onFocus }) => {
  if (!autoSelect) {
    return {
...
const Textarea = reactExports.forwardRef((props, ref) => {
  const { autoSelect = true, tip, placeholder, $pp, $wrapped: { $onValueChange, $root, $model, $p2r, $avs: { $disabled, $visible } }, ...rest } = props;
  const globalHandlers = useGlobalHandlers();
  ...
  const displayValue = compositionRef.current.ing ? compositionRef.current.text : MUtils.getValue($model, $pp) ?? "";
  const onCompositionStart = () => {
    compositionRef.current = { ing: true, text: displayValue };
  };
  const onCompositionEnd = async () => {
  ...
  return React.createElement(ATextarea, { ...rest, placeholder: i18nPlaceholder, autoSelect, disabled: $disabled, "data-disabled": $disabled, "data-visible": $visible, value: displayValue, onChange, onCompositionStart, onCompositionEnd, id: PPUtils.asId(PPUtils.absolute($p2r, $pp), props.id), ref: textRef });
});
...
const PopupTree$1 = dt(UnwrappedTree)`
    border: 0;
`;
const InternalDropdownTree = reactExports.forwardRef((props, ref) => {
  const { options, optionSort, noAvailable, noMatched, $pp, $wrapped: { $onValueChange, $root, $model, $p2r, $avs: { $disabled, $visible } }, please = "", clearable = true, couldSelect, initExpandLevel = 0, tip, ...rest } = props;
  const globalHandlers = useGlobalHandlers();
  ...
  const { askOptions, filterInputRef, filter, onFilterChanged, active: filterActive, containerRef, popupState, popupRef, popupShown, setPopupShown, afterPopupStateChanged, onClicked, onFocused, onKeyUp, onAnyInputEvent, onCompositionStart, onCompositionEnd } = useFilterableDropdownOptions({ ...props, takeoverFilter: false, filterChanged });
  useDualRefs(containerRef, ref);
  useTip({ ref: containerRef, ...buildTip({ tip, root: $root, model: $model }) });
  const forceUpdate = useForceUpdate();
  const onClearClicked = async (event) => {
  ...
  return React.createElement(
    ...
    React.createElement(DropdownLabel, { "data-please": !selected }, toIntlLabel(label)),
    React.createElement(DropdownStick, { valueAssigned: selected, clearable, clear: onClearClicked, disabled: $disabled, fix: DropdownDefaults.DEFAULTS.FIX_DROPDOWN_TREE_STICK }),
    isDropdownPopupActive(popupState.active) ? React.createElement(
      DropdownPopup,
      { ...popupState, minHeight: popupHeight, shown: popupShown && popupState.active === DropdownPopupStateActive.ACTIVE, onKeyDown: onAnyInputEvent, ...deviceTags, vScroll: true, ref: popupRef },
      React.createElement(
        OptionFilter,
        { ...popupState, active: filterActive, "data-w": "d9-dropdown-tree-option-filter" },
        React.createElement("span", null, "?:"),
        React.createElement(
          "span",
          null,
      ...
      React.createElement(
        PopupTree$1,
        { data: treeModel, initExpandLevel, disableSearchBox: true, detective, height: treeHeight },
...
const MultiDropdownTreeContainer = dt(DropdownContainer)`
    align-self: start;
    flex-wrap: wrap;
    height: unset;
    min-height: ${CssVars.INPUT_HEIGHT};
...
`;
const MultiDropdownTreeLabel = dt(DropdownLabel)`
    flex-grow: unset;
    border: ${CssVars.BORDER};
    border-radius: ${CssVars.BORDER_RADIUS};
    color: ${CssVars.FONT_COLOR};
...
`;
const MultiDropdownTreeStick = dt(DropdownStick)`
    position: absolute;
    right: calc(${CssVars.INPUT_INDENT});
...
`;
const PopupTree = dt(UnwrappedTree)`
    border: 0;
`;
const InternalMultiDropdownTree = reactExports.forwardRef((props, ref) => {
  ...
  const { askOptions, filterInputRef, filter, onFilterChanged, active: filterActive, containerRef, popupState, popupRef, popupShown, repaintPopup, onClicked, onFocused, onKeyUp, onAnyInputEvent, onCompositionStart, onCompositionEnd } = useFilterableDropdownOptions({ ...props, takeoverFilter: false, filterChanged });
  const forceUpdate = useForceUpdate();
  useDualRefs(containerRef, ref);
  useTip({ ref: containerRef, ...buildTip({ tip, root: $root, model: $model }) });
  const currentValuesToArray = () => {
  ...
  return React.createElement(
    ...
    { active: popupState.active, atBottom: popupState.atBottom, role: "input", tabIndex: 0, ...rest, "data-w": "d9-multi-dropdown-tree", "data-disabled": $disabled, "data-visible": $visible, "data-clearable": clearable, "data-dual-sticks": selected && clearable && (DropdownDefaults.DEFAULTS.FIX_MULTI_DROPDOWN_TREE_STICK ?? DropdownDefaults.DEFAULTS.FIX_STICK), onFocus: onFocused, onClick: onClicked, onKeyDown: onAnyInputEvent, id: PPUtils.asId(PPUtils.absolute($p2r, $pp), props.id), ref: containerRef },
    values.map((value) => {
      var _a;
      const v = `${value}`;
      return React.createElement(
    ...
    React.createElement(DropdownLabel, { "data-please": true }, toIntlLabel(please)),
    React.createElement(MultiDropdownTreeStick, { valueAssigned: selected, clearable, clear: onClearClicked, disabled: $disabled, fix: DropdownDefaults.DEFAULTS.FIX_MULTI_DROPDOWN_TREE_STICK }),
    isDropdownPopupActive(popupState.active) ? React.createElement(
      DropdownPopup,
      { ...popupState, minHeight: popupHeight, shown: popupShown && popupState.active === DropdownPopupStateActive.ACTIVE, onKeyDown: onAnyInputEvent, ...deviceTags, vScroll: true, ref: popupRef },
      React.createElement(
        OptionFilter,
        { ...popupState, active: filterActive, "data-w": "d9-multi-dropdown-tree-option-filter" },
        React.createElement("span", null, "?:"),
        React.createElement(
          "span",
          null,
...
const StyleSheetManager = (props) => {
  const [shouldForwardProp] = reactExports.useState(() => {
    ...
    const ignoreRules = [
      (...data) => ignoredRegexps.some((ignore) => ignore.test(data[0])),
      (...data) => {
        var _a;
        return /^Warning: Invalid values? for props? %s on <%s> tag./.test(data[0]) && ((_a = data[1]) == null ? void 0 : _a.includes("@data-"));
      },
      (...data) => /^Warning: Invalid attribute name: `%s`%s/.test(data[0]) && data[1].includes("@data-"),
      ...props.ignoreRules ?? []
    ];
  ...
  return React.createElement(Ye, { ...props, shouldForwardProp });
};
reactExports.forwardRef((props, ref) => {
  const { children, visible, ...rest } = props;
  const $onValueChange = VUtils.noop;
  const $avs = { $disabled: false, $visible: visible };
  const $root = {};
  return React.createElement(Box, { ...rest, "$nodes": [], "$wrapped": { $onValueChange, $avs, $root, $model: $root, $p2r: "." }, id: rest.id ?? VUtils.generateUniqueId(), ref }, children);
});
...
const ACheckboxes = dt.div.attrs(({ id }) => {
  return {
    ...
    color: ${CssVars.FONT_COLOR};
`;
const Option$1 = dt.span.attrs(({ columns, compact, [DOM_KEY_WIDGET]: dataW }) => {
  return {
...
`;
const Separator$1 = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-checkboxes-option-separator" })`
    display: block;
    position: relative;
    height: 0;
    flex-basis: 100%;
...
const ARadios = dt.div.attrs(({ id }) => {
  return {
    ...
    color: ${CssVars.FONT_COLOR};
`;
const Option = dt.span.attrs(({ columns, compact, [DOM_KEY_WIDGET]: dataW }) => {
  return {
...
`;
const Separator = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-radios-option-separator" })`
    display: block;
    position: relative;
    height: 0;
    flex-basis: 100%;
...
export {
  ...
  TreeNodeCheckedChangeFrom as H,
  IntlLabel as I,
  UnwrappedSection as J,
  LabelLike as L,
  OptionItemSort as O,
  REACTION_REFRESH_OPTIONS as R,
  StyleSheetManager as S,
  TableColumnSortType as T,
