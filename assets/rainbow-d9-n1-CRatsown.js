...
import { b as buffer, n as nanoid, E as EventEmitter } from "./vendor-ZsxnF1J5.js";
import { r as reactExports, R as React } from "./react-base-Cso2gUFw.js";
const VUtils = {
...
const handleExternalDefs = (options, reb, externalDefs) => {
  if (options == null || VUtils.isPrimitive(options) || reactExports.isValidElement(options)) {
    return options;
  }
...
const getArrayElementKey = (keys, getElementKey) => (element, index) => {
