...
import { a as color, M as MaskedNumber, e as MaskedDate, g as MaskedFunction, j as MaskedPattern, k as MaskedRange, p as MaskedRegExp, q as MaskedDynamic } from "./vendor-BE3DymIA.js";
import { R as React, r as reactExports, q as qe, W as We, u as useIMask, a as reactDomExports } from "./react-base-BiuHKrpQ.js";
import { c as createLogger, V as VUtils, P as PPUtils, r as registerWidget, a as useThrottler, u as useRootEventBus, M as MUtils, N as NUtils, d as Wrapper, e as useForceUpdate, f as MBUtils, b as useWrapperEventBus, W as WrapperEventTypes, g as useCreateEventBus, h as PROPERTY_PATH_ME, i as useDefaultAttributeValues, j as useAttributesWatch, R as RootEventTypes } from "./rainbow-d9-n1-Cy022HpC.js";
...
const DropdownPopup = reactExports.forwardRef((props, ref) => {
  ...
  if (DropdownDefaults.DEFAULTS.findPortalCarrier == null) {
    ...
    return reactDomExports.createPortal(React.createElement(DropdownPopupContainer, { shown, vScroll, hScroll, ...state, ref }, children), DropdownDefaults.DEFAULTS.findPortalCarrier());
  }
});
