...
import { i as index$2, I as IntlLabel, D as DOM_KEY_WIDGET, C as CssVars, d as utils$2, b as useGlobalHandlers, t as toIntlLabel, U as UnwrappedButton, B as ButtonInk, e as ButtonFill } from "./rainbow-d9-n2-BUksr4gd.js";
import { R as React, r as reactExports, d as dt } from "./react-base-CBrbgs-S.js";
import { V as VUtils, r as registerWidget, g as useCreateEventBus, M as MUtils, P as PPUtils, a as useThrottler, u as useRootEventBus, R as RootEventTypes, e as useForceUpdate, S as StandaloneRoot, m as ExternalDefMismatchIndicator } from "./rainbow-d9-n1-CPMXirX1.js";
import { T as Tag, r as tags, V as ViewPlugin, u as syntaxTree, H as HighlightStyle, v as defaultHighlightStyle, w as syntaxHighlighting, x as styleTags, D as Decoration, I as InlineContext, W as WidgetType, y as EditorView, z as EditorState, A as basicSetup, B as keymap, C as indentWithTab, F as markdown, G as javascript, J as markdownLanguage, K as lintGutter, L as linter, N as json, O as jsonParseLinter, P as Compartment } from "./vendor-BLpR10-V.js";
import { a as index, b as index$2$1, i as index$1, p as parseDoc } from "./rainbow-d9-n3-CPTvkYwU.js";
...
const ToolbarWrapper = dt.div.attrs(() => {
  return {
...
`;
const PrimaryToolbar = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-toolbar-primary" })`
    display: flex;
    position: relative;
...
`;
const SecondaryToolbar = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-toolbar-secondary" })`
    display: flex;
    position: relative;
    flex-direction: column;
    padding: 8px 0;
`;
const ToolbarSeparator = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-playground-toolbar-separator" })`
    display: block;
    position: relative;
    margin: 4px 0;
...
`;
const ToolbarButtonTooltip = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-toolbar-tooltip" })`
    display: flex;
    position: relative;
    align-items: center;
    ...
    if (((_a = node.node.parent) == null ? void 0 : _a.name) === "WidgetDeclaration") {
      if (((_c = (_b = node.node.parent.parent) == null ? void 0 : _b.name) == null ? void 0 : _c.startsWith("ATXHeading")) && ((_d = node.node.parent.parent) == null ? void 0 : _d.name) !== "ATXHeading1" && type === index.N2WidgetType.PAGE) {
        diagnostics.push({
          ...
          to: node.to,
          severity: "error",
          message: "Widget[Page] is allowed on heading level 1 only."
        });
      } else {
...
const WidgetTemplateDialogContainer = dt.div.attrs(({ visible }) => {
  return {
...
`;
const WidgetTemplateDialogWrapper = dt.div.attrs(({ visible }) => {
  return {
    ...
    transition: all ${CssVars.TRANSITION_DURATION} ${CssVars.TRANSITION_TIMING_FUNCTION};
`;
const WidgetTemplateDialogBody = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-widget-template-dialog-body" })`
    display: flex;
    position: relative;
    flex-direction: column;
    flex-grow: 1;
...
`;
const WidgetTemplateViewerWrapper = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-widget-template-viewer-wrapper" })`
    display: grid;
    position: relative;
    align-self: stretch;
    flex-grow: 1;
    ...
    overflow: hidden;
`;
const WidgetTemplateViewer = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-widget-template-viewer" })`
    display: block;
    position: relative;
    width: 100%;
    align-self: stretch;
...
`;
const WidgetTemplateReason = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-widget-template-dialog-reason" })`
    display: flex;
    position: relative;
    align-items: center;
    font-size: 1.1em;
...
`;
const WidgetTemplateDialogFooter = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-widget-template-dialog-footer" })`
    display: flex;
...
const EditorWrapper = dt.div.attrs(({ editorSize }) => {
  return {
...
`;
const EditorPanel = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-editor-panel" })`
    display: block;
    position: relative;
    width: 100%;
    align-self: stretch;
  ...
  reactExports.useEffect(() => {
    ...
    const onInsertWidgetTemplate = (keyOrWidgetType) => {
      ...
      if (from !== to && text.trim().length !== 0) {
        fire(PlaygroundEventTypes.SHOW_WIDGET_TEMPLATE_DIALOG, keyOrWidgetType, findDefaultPrefix(keyOrWidgetType, findClosestPreviousHeadingLevel(fromLineNumber)), "The current selection in the designer already contains content, so it cannot be directly inserted the widget template.");
        return;
      }
      const { number: toLineNumber } = editorState.doc.lineAt(to);
      if (fromLineNumber !== toLineNumber) {
        fire(PlaygroundEventTypes.SHOW_WIDGET_TEMPLATE_DIALOG, keyOrWidgetType, findDefaultPrefix(keyOrWidgetType, findClosestPreviousHeadingLevel(fromLineNumber)), "The current selection contains multiple lines, so it cannot be directly inserted the widget template.");
        return;
      }
      let indent = "";
      let prefix = "";
      if (fromLineText.trim().length !== 0) {
        ...
        if (symbol == null || spaces.length !== 0 && symbol.includes("#")) {
          fire(PlaygroundEventTypes.SHOW_WIDGET_TEMPLATE_DIALOG, keyOrWidgetType, findDefaultPrefix(keyOrWidgetType, findClosestPreviousHeadingLevel(fromLineNumber)), "The selected line is neither a heading nor a bullet list, so it cannot be directly inserted into the widget template.");
          return;
        }
        if (content2.trim().length !== 0) {
          fire(PlaygroundEventTypes.SHOW_WIDGET_TEMPLATE_DIALOG, keyOrWidgetType, findDefaultPrefix(keyOrWidgetType, findClosestPreviousHeadingLevel(fromLineNumber)), "The selected line already contains content, so it cannot be directly inserted into the widget template.");
          return;
        }
        indent = spaces;
        prefix = symbol;
      } else {
        prefix = findDefaultPrefix(keyOrWidgetType, findClosestPreviousHeadingLevel(fromLineNumber));
      }
      let template = ((_a = widgets.widgets.find((widget) => widget.$key === keyOrWidgetType)) == null ? void 0 : _a.template) ?? ((_b = widgets.widgets.find((widget) => widget.$wt === keyOrWidgetType)) == null ? void 0 : _b.template) ?? "";
...
const HelpWrapper = dt.div.attrs(() => {
  return {
...
const WidgetWrapperAnchor = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-playground-widget-wrapper-anchor" })`
    display: none;
`;
...
const ViewerWrapper = dt.div.attrs(({ minViewerWidth }) => {
  return {
...
`;
const ParseError = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-viewer-error" })`
    display: flex;
    position: relative;
    align-items: center;
    padding: 16px 32px;
    ...
    font-weight: 500;
`;
const WidgetWrapper = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-widget-wrapper" })`
    display: block;
    position: absolute;
    top: 0;
    left: 0;
...
`;
const WidgetWrapperToolbar = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-widget-wrapper-toolbar" })`
    display: flex;
    position: fixed;
    left: 0;
    bottom: 0;
...
const MockJsonDialogContainer = dt.div.attrs(({ visible }) => {
  return {
    ...
    z-index: ${CssVars.DIALOG_Z_INDEX};
`;
const MockJsonDialogWrapper = dt.div.attrs(({ visible }) => {
  return {
    ...
    transition: all ${CssVars.TRANSITION_DURATION} ${CssVars.TRANSITION_TIMING_FUNCTION};
`;
const MockJsonDialogBody = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-mock-json-dialog-body" })`
    display: flex;
    position: relative;
    flex-direction: column;
    flex-grow: 1;
    ...
    color: ${CssVars.CAPTION_FONT_COLOR};
`;
const MockJsonViewerWrapper = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-mock-json-viewer-wrapper" })`
    display: grid;
    position: relative;
    align-self: stretch;
    flex-grow: 1;
    ...
    overflow: hidden;
`;
const MockJsonViewer = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-mock-json-viewer" })`
    display: block;
    position: relative;
    width: 100%;
    align-self: stretch;
...
`;
const MockJsonReason = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-mock-json-dialog-reason" })`
    display: flex;
    position: relative;
    align-items: center;
    font-size: 1.1em;
...
`;
const MockJsonDialogFooter = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-playground-mock-json-dialog-footer" })`
    display: flex;
    justify-content: flex-end;
...
const SideSlider = dt.div.attrs(({ active, left }) => {
  return {
...
const PlaygroundWrapper = dt.div.attrs(() => {
  return {
