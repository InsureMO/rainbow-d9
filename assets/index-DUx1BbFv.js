import { d as dt, r as reactExports, R as React, v as jsxRuntimeExports, x as ft, y as client } from "./react-base-vOZIMCQz.js";
import { G as javascript, y as EditorView, z as EditorState, A as basicSetup, Z as indentUnit, B as keymap, C as indentWithTab, K as lintGutter, P as Compartment, b9 as vscodeDark, ba as vscodeLight, n as nanoid } from "./vendor-D3SH2Xzs.js";
import { M as MUtils, V as VUtils, a as useThrottler, u as useRootEventBus, R as RootEventTypes, r as registerWidget, n as N1Logger, P as PPUtils, S as StandaloneRoot, B as BridgeEventBusProvider, o as useBridgeEventBus, p as BridgeToRootEventTypes, E as ExternalDefIndicator, f as MBUtils, e as useForceUpdate, D as DeviceDetective } from "./rainbow-d9-n1-CDxygE-F.js";
import { C as CssVars, d as utils$2, D as DOM_KEY_WIDGET, b as useGlobalHandlers, y as utils$3, z as DropdownUtils, x as GlobalRoot, A as utils$1, o as index$1$1, $ as $d9n2, u as useGlobalEventBus, E as UnwrappedButtonBar, F as ButtonBarAlignment, U as UnwrappedButton, G as GlobalEventTypes, n as UnwrappedCaption, T as TableColumnSortType, H as TreeNodeCheckedChangeFrom, J as UnwrappedSection, B as ButtonInk, e as ButtonFill, S as StyleSheetManager } from "./rainbow-d9-n2-BPVpjTcd.js";
import { c as createCodeMirrorTs562Es2022Extensions, r as registerPlayground$1 } from "./rainbow-d9-n6-XqHIgSVs.js";
import { i as index$1, r as registerN2Widgets } from "./rainbow-d9-n3-CVFw_ne7.js";
import { r as registerCharts } from "./rainbow-d9-echarts-CJU-Jn06.js";
import { r as registerPlayground } from "./rainbow-d9-n5-BEFD_Fhl.js";
import { r as registerPlanSelect, u as useDemoMarkdown, C as CustomEventHandler, N as N2DemoDialogHandler, T as ThaiPlanSelection, a as ThaiPlanSelectionData, b as ThaiPlanSelectionMarkdown, P as PlanSelectionCssVars } from "./rainbow-d9-thai-plan-selection-BCnO4IpO.js";
import { d as dayjs, W as WeekOfYear, Q as QuarterOfYear, D as Duration, I as IsToday, R as RelativeTime, A as ArraySupport, O as ObjectSupport, C as CustomParseFormat, U as UTC, B as BuddhistEra } from "./dayjs-qTzHwIQv.js";
...
import { M as Markdown } from "./react-markdown-4z90vZMr.js";
import { r as remarkGfm } from "./remark-BjJGHaQp.js";
import { h as highlighter, m as materialDark } from "./react-syntax-highlighter-TCYjvrfS.js";
import "./babel-CtyNlyuP.js";
import "./unist-Cr0TYu97.js";
import "./mdast-H3lPvzqu.js";
import "./micromark-B8nfmDek.js";
import "./zrender-gOOSvhfg.js";
import "./refractor-DcZwKFAZ.js";
import "./hastscript-CyIm9Exv.js";
(function polyfill() {
...
const useHandleCodeChange$1 = (options) => {
...
const useInitCodeContent$1 = (options) => {
...
const useInitEditor$1 = (options) => {
  ...
  reactExports.useEffect(() => {
    ...
    const { extension: changeableThemeExtension, listener: themeListener } = createTheme$1(createThemeExtension);
  ...
  useTheme$1({ createThemeExtension, editor: state.editor, listener: state.themeListener });
  return { ref };
};
const CodeEditorCssVars$1 = {
...
const EditorContainer$1 = dt.div`
    display: block;
    position: relative;
    ...
    > div.cm-editor {
        ...
        > div.cm-scroller {
            ...
            > div.cm-content {
                > div.cm-line.cm-activeLine {
                    background-color: ${CodeEditorCssVars$1.ACTIVE_LINE_BACKGROUND_COLOR};
                }
            }
        }
        ...
        div.cm-search.cm-panel {
            ...
            grid-row-gap: 8px;
            background-color: ${CodeEditorCssVars$1.SEARCH_PANEL_BACKGROUND_COLOR};
            ...
            > button {
                ...
                background-color: ${CodeEditorCssVars$1.SEARCH_PANEL_BUTTON_BACKGROUND_COLOR};
                color: ${CssVars.FONT_COLOR};
                border: ${CssVars.BORDER};
                border-radius: ${CssVars.BORDER_RADIUS};
...
`;
const useDefaultExtensionsCreate$1 = (defaultCreate, given) => {
...
const useDualRefs$1 = utils$2.useDualRefs;
const CodeEditor$1 = reactExports.forwardRef((props, ref) => {
  ...
  const { ref: divRef } = useInitEditor$1({ state, setState, createExtensions, createThemeExtension });
  useDualRefs$1(divRef, ref);
  useInitCodeContent$1({ editor: state.editor, content: MUtils.getValue($model, $pp) ?? "" });
  useHandleCodeChange$1({ ...state, onChange: $onValueChange, delay: valueSyncDelay });
  return React.createElement(C, { "data-height": height, "data-disabled": $disabled, "data-visible": $visible, ref: divRef });
});
const JsEditorContainer$1 = dt(EditorContainer$1).attrs(({ "data-height": height }) => {
  return {
...
const JsEditor$1 = reactExports.forwardRef((props, ref) => {
  const createExtensions = useDefaultExtensionsCreate$1(createJsExtensions$1, props.createExtensions);
  return React.createElement(CodeEditor$1, { ...props, createExtensions, C: JsEditorContainer$1, ref });
});
const TsEditorContainer$1 = dt(EditorContainer$1).attrs(({ "data-height": height }) => {
  return {
...
const TsEditor = reactExports.forwardRef((props, ref) => {
  const createExtensions = useDefaultExtensionsCreate$1(createTsExtensions$1, props.createExtensions);
  return React.createElement(CodeEditor$1, { ...props, createExtensions, C: TsEditorContainer$1, ref });
});
const createJsExtensions$1 = (options) => {
...
const createTsExtensions$1 = (options) => {
  return createJsExtensions$1({ ...options, typescript: true });
};
reactExports.forwardRef((props, ref) => {
  ...
  const $root = { [$pp]: value };
  return React.createElement(JsEditor$1, { ...rest, "$wrapped": { $onValueChange, $avs, $root, $model: $root, $p2r: "." }, "$pp": $pp, id: rest.id ?? VUtils.generateUniqueId(), ref });
});
const CreateExtensionsDefsBuild$1 = index$1.createSyncSnippetBuild("createExtensions", []);
const CreateThemeExtensionDefsBuild$1 = index$1.createSyncSnippetBuild("createThemeExtension", ["theme"]);
let AbstractCodeEditorTranslator$1 = class AbstractCodeEditorTranslator extends index$1.SpecificWidgetTranslator {
  ...
  getAttributeValueBuilders() {
    return [
      CreateExtensionsDefsBuild$1,
      CreateThemeExtensionDefsBuild$1
    ];
  }
};
const registerCodeEditor = (widgetHelper, widgetType, JSX) => {
  registerWidget({ key: widgetType, JSX, container: false, array: false });
  const TranslatorClass = class extends AbstractCodeEditorTranslator$1 {
    getSupportedType() {
      return widgetType;
    }
  };
...
const registerCodeEditors = (widgetHelper, widgetTypes) => {
  registerCodeEditor(widgetHelper, "JS", JsEditor$1);
  registerCodeEditor(widgetHelper, "TS", TsEditor);
};
var define_process_env_default = { GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_b8d39e58-1273-4863-a356-b32f71d58488", npm_package_scripts_build_n5_ci: "cd ./d9-n5 && yarn build-ci", npm_package_scripts_build_sample_cra: "cd ./d9-sample-cra && yarn build", STATS_TRP: "true", DEPLOYMENT_BASEPATH: "/opt/runner", DOTNET_NOLOGO: "1", npm_package_scripts_build_n6_ci: "cd ./d9-n6 && yarn build-ci", npm_package_dependencies__vitejs_plugin_react: "^4.3.1", USER: "runner", npm_config_version_commit_hooks: "true", npm_config_user_agent: "yarn/1.22.21 npm/? node/v18.20.7 linux x64", npm_package_dependencies__types_jest: "^29.5.4", CI: "true", npm_config_bin_links: "true", npm_package_bugs_url: "https://github.com/InsureMO/rainbow-d9/issues", npm_config_wrap_output: "", RUNNER_ENVIRONMENT: "github-hosted", GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_b8d39e58-1273-4863-a356-b32f71d58488", PIPX_HOME: "/opt/pipx", npm_node_execpath: "/opt/hostedtoolcache/node/18.20.7/x64/bin/node", npm_package_scripts_build_thai_all_ci: "yarn build-thai-plan-selection-ci", npm_package_scripts_build_ts_vfs: "cd ./d9-ts-vfs && yarn build", npm_config_init_version: "1.0.0", npm_package_devDependencies_gh_pages: "^6.1.1", npm_package_dependencies__babel_plugin_proposal_private_property_in_object: "^7.21.11", JAVA_HOME_8_X64: "/usr/lib/jvm/temurin-8-jdk-amd64", SHLVL: "1", HOME: "/home/runner", OLDPWD: "/home/runner/work/rainbow-d9/rainbow-d9", npm_package_browserslist_production_0: ">0.2%", RUNNER_TEMP: "/home/runner/work/_temp", GITHUB_EVENT_PATH: "/home/runner/work/_temp/_github_workflow/event.json", npm_package_scripts_build_all: "yarn build-ts-vfs && yarn build-n123 && yarn build-n5 && yarn build-n6 && yarn build-code-editor && yarn build-echarts && yarn build-thai-all && yarn build-npx", npm_package_browserslist_production_1: "not dead", npm_package_dependencies_react_syntax_highlighter: "^15.5.0", JAVA_HOME_11_X64: "/usr/lib/jvm/temurin-11-jdk-amd64", PIPX_BIN_DIR: "/opt/pipx_bin", GITHUB_REPOSITORY_OWNER: "InsureMO", npm_package_volta_node: "22.11.0", npm_config_init_license: "MIT", npm_package_browserslist_production_2: "not op_mini all", GRADLE_HOME: "/usr/share/gradle-8.13", ANDROID_NDK_LATEST_HOME: "/usr/local/lib/android/sdk/ndk/28.0.13004108", JAVA_HOME_21_X64: "/usr/lib/jvm/temurin-21-jdk-amd64", STATS_RDCL: "true", GITHUB_RETENTION_DAYS: "90", YARN_WRAP_OUTPUT: "false", npm_package_scripts_build_thai_plan_selection_ci: "cd ./d9-thai-plan-selection && yarn build-ci", npm_package_scripts_build_n1: "cd ./d9-n1 && yarn build", npm_config_version_tag_prefix: "v", npm_package_dependencies__rainbow_d9_n2: "1.2.27", GITHUB_REPOSITORY_OWNER_ID: "38915232", POWERSHELL_DISTRIBUTION_CHANNEL: "GitHub-Actions-ubuntu24", AZURE_EXTENSION_DIR: "/opt/az/azcliextensions", GITHUB_HEAD_REF: "", npm_package_scripts_build_n2: "cd ./d9-n2 && yarn build", npm_package_dependencies__rainbow_d9_n3: "1.2.27", npm_package_dependencies__rainbow_d9_echarts: "1.2.27", SYSTEMD_EXEC_PID: "833", npm_package_scripts_build_echarts: "cd ./d9-echarts && yarn build", npm_package_scripts_build_n3: "cd ./d9-n3 && yarn build", GITHUB_GRAPHQL_URL: "https://api.github.com/graphql", npm_package_description: "Assume the following envs are ready, otherwise contact the tech guy.", npm_package_scripts_predeploy: "npm run build", npm_package_dependencies__rainbow_d9_n5: "1.2.27", NVM_DIR: "/home/runner/.nvm", npm_package_readmeFilename: "README.md", npm_package_scripts_build_n5: "cd ./d9-n5 && yarn build", npm_package_dependencies__types_react: "^18.3.3", npm_package_dependencies__testing_library_react: "^13.4.0", npm_package_dependencies__rainbow_d9_n6: "1.2.27", DOTNET_SKIP_FIRST_TIME_EXPERIENCE: "1", GOROOT_1_21_X64: "/opt/hostedtoolcache/go/1.21.13/x64", JAVA_HOME_17_X64: "/usr/lib/jvm/temurin-17-jdk-amd64", ImageVersion: "20250316.1.0", npm_package_scripts_build_n6: "cd ./d9-n6 && yarn build", RUNNER_OS: "Linux", GITHUB_API_URL: "https://api.github.com", GOROOT_1_22_X64: "/opt/hostedtoolcache/go/1.22.12/x64", SWIFT_PATH: "/usr/share/swift/usr/bin", npm_package_scripts_build_code_editor_ci: "cd ./d9-code-editor && yarn build-ci", npm_package_type: "module", RUNNER_USER: "runner", STATS_V3PS: "true", CHROMEWEBDRIVER: "/usr/local/share/chromedriver-linux64", GOROOT_1_23_X64: "/opt/hostedtoolcache/go/1.23.7/x64", JOURNAL_STREAM: "8:6690", GITHUB_WORKFLOW: "Publish to NPM", _: "/opt/hostedtoolcache/node/18.20.7/x64/bin/yarn", npm_package_private: "true", npm_package_dependencies_remark_gfm: "4.0.0", MEMORY_PRESSURE_WATCH: "/sys/fs/cgroup/system.slice/runner-provisioner.service/memory.pressure", npm_package_scripts_build_thai_all: "yarn build-thai-plan-selection", npm_config_registry: "https://registry.yarnpkg.com", ACTIONS_RUNNER_ACTION_ARCHIVE_CACHE: "/opt/actionarchivecache", STATS_D: "true", GITHUB_RUN_ID: "14216716882", STATS_VMFE: "true", npm_package_workspaces_0: "d9-ts-vfs", GITHUB_REF_TYPE: "tag", BOOTSTRAP_HASKELL_NONINTERACTIVE: "1", GITHUB_WORKFLOW_SHA: "fe7dd9e5cd47cf8c88ea83a9e7036dadeb83d327", GITHUB_BASE_REF: "", ImageOS: "ubuntu24", npm_package_scripts_build_n123_ci: "yarn build-n1-ci && yarn build-n2-ci && yarn build-n3-ci", npm_package_workspaces_1: "d9-n1", npm_config_ignore_scripts: "", npm_package_scripts_start: "vite", npm_package_dependencies_github_markdown_css: "^5.5.0", GITHUB_WORKFLOW_REF: "InsureMO/rainbow-d9/.github/workflows/release.yml@refs/tags/r-1.2.28", PERFLOG_LOCATION_SETTING: "RUNNER_PERFLOG", GITHUB_ACTION_REPOSITORY: "", npm_package_workspaces_2: "d9-n2", npm_package_browserslist_development_0: "last 1 chrome version", PATH: "/tmp/yarn--1743588218370-0.5071465921653291:/home/runner/work/rainbow-d9/rainbow-d9/d9-sample-cra/node_modules/.bin:/home/runner/.config/yarn/link/node_modules/.bin:/home/runner/work/rainbow-d9/rainbow-d9/node_modules/.bin:/opt/hostedtoolcache/node/18.20.7/x64/libexec/lib/node_modules/npm/bin/node-gyp-bin:/opt/hostedtoolcache/node/18.20.7/x64/lib/node_modules/npm/bin/node-gyp-bin:/opt/hostedtoolcache/node/18.20.7/x64/bin/node_modules/npm/bin/node-gyp-bin:/tmp/yarn--1743588218182-0.7223454193549432:/home/runner/work/rainbow-d9/rainbow-d9/node_modules/.bin:/home/runner/.config/yarn/link/node_modules/.bin:/home/runner/work/rainbow-d9/rainbow-d9/node_modules/.bin:/opt/hostedtoolcache/node/18.20.7/x64/libexec/lib/node_modules/npm/bin/node-gyp-bin:/opt/hostedtoolcache/node/18.20.7/x64/lib/node_modules/npm/bin/node-gyp-bin:/opt/hostedtoolcache/node/18.20.7/x64/bin/node_modules/npm/bin/node-gyp-bin:/opt/hostedtoolcache/node/18.20.7/x64/bin:/snap/bin:/home/runner/.local/bin:/opt/pipx_bin:/home/runner/.cargo/bin:/home/runner/.config/composer/vendor/bin:/usr/local/.ghcup/bin:/home/runner/.dotnet/tools:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin", NODE: "/opt/hostedtoolcache/node/18.20.7/x64/bin/node", ANT_HOME: "/usr/share/ant", DOTNET_MULTILEVEL_LOOKUP: "0", RUNNER_TRACKING_ID: "github_acfc8ad3-3bcc-4ee2-8d38-579c37ec933f", INVOCATION_ID: "b0090f10340345c9b753aec17fe00c79", RUNNER_TOOL_CACHE: "/opt/hostedtoolcache", npm_package_name: "@rainbow-d9/sample-cra", npm_package_workspaces_3: "d9-n3", npm_package_browserslist_development_1: "last 1 firefox version", npm_package_repository_type: "git", npm_package_dependencies__types_react_syntax_highlighter: "^15.5.11", npm_package_dependencies__rainbow_d9_thai_plan_selection: "1.2.27", GITHUB_ACTION: "__run_5", GITHUB_RUN_NUMBER: "186", GITHUB_TRIGGERING_ACTOR: "bradwoo8621", RUNNER_ARCH: "X64", XDG_RUNTIME_DIR: "/run/user/1001", AGENT_TOOLSDIRECTORY: "/opt/hostedtoolcache", npm_package_scripts_build_n99_ci: "cd ./d9-n99 && yarn build", npm_package_scripts_build_thai_plan_selection: "cd ./d9-thai-plan-selection && yarn build", npm_package_workspaces_4: "d9-n5", npm_package_browserslist_development_2: "last 1 safari version", npm_package_scripts_build_npx_ci: "cd ./create-rainbow-d9-app && yarn build-ci", npm_package_workspaces_5: "d9-n6", LANG: "C.UTF-8", VCPKG_INSTALLATION_ROOT: "/usr/local/share/vcpkg", npm_package_workspaces_6: "d9-n99", npm_package_dependencies_react_dom: "^18.3.1", CONDA: "/usr/share/miniconda", RUNNER_NAME: "GitHub-Actions-1000000324", XDG_CONFIG_HOME: "/home/runner/.config", STATS_VMD: "true", GITHUB_REF_NAME: "r-1.2.28", GITHUB_REPOSITORY: "InsureMO/rainbow-d9", STATS_D_D: "true", npm_lifecycle_script: "vite build", npm_package_workspaces_7: "d9-code-editor", npm_package_eslintConfig_extends_0: "react-app", npm_package_dependencies_react_markdown: "9.0.1", npm_package_dependencies__types_node: "^20.5.3", STATS_UE: "true", ANDROID_NDK_ROOT: "/usr/local/lib/android/sdk/ndk/27.2.12479018", GITHUB_ACTION_REF: "", DEBIAN_FRONTEND: "noninteractive", npm_package_scripts_build_sample_cra_ci: "cd ./d9-sample-cra && yarn build", npm_package_workspaces_8: "d9-echarts", npm_config_version_git_message: "v%s", npm_package_eslintConfig_extends_1: "react-app/jest", GITHUB_REPOSITORY_ID: "704514093", GITHUB_ACTIONS: "true", STATS_PIP: "false", npm_lifecycle_event: "build", npm_package_version: "1.2.27", npm_package_workspaces_9: "d9-thai-plan-selection", npm_package_repository_url: "git+https://github.com/InsureMO/rainbow-d9.git", npm_package_dependencies__testing_library_jest_dom: "^5.17.0", npm_package_dependencies__rollup_pluginutils: "^5.1.0", npm_package_dependencies__rainbow_d9_code_editor: "1.2.27", GITHUB_REF_PROTECTED: "false", npm_config_argv: '{"remain":[],"cooked":["run","build-sample-cra"],"original":["build-sample-cra"]}', npm_package_volta_yarn: "1.22.21", npm_package_scripts_build_code_editor: "cd ./d9-code-editor && yarn build", npm_package_workspaces_10: "d9-sample-cra", npm_package_scripts_build: "vite build", npm_package_dependencies__uiw_codemirror_theme_vscode: "^4.23.0", npm_package_dependencies__testing_library_user_event: "^13.5.0", GITHUB_WORKSPACE: "/home/runner/work/rainbow-d9/rainbow-d9", ACCEPT_EULA: "Y", GITHUB_JOB: "create-sample-pages", RUNNER_PERFLOG: "/home/runner/perflog", npm_package_workspaces_11: "create-rainbow-d9-app", npm_package_dependencies_vite: "^5.4.12", GITHUB_SHA: "fe7dd9e5cd47cf8c88ea83a9e7036dadeb83d327", GITHUB_RUN_ATTEMPT: "1", STATS_D_TC: "true", npm_package_scripts_build_ts_vfs_ci: "cd ./d9-ts-vfs && yarn build-ci", npm_config_version_git_tag: "true", npm_config_version_git_sign: "", GITHUB_REF: "refs/tags/r-1.2.28", GITHUB_ACTOR: "bradwoo8621", ANDROID_SDK_ROOT: "/usr/local/lib/android/sdk", npm_package_license: "MIT", npm_config_strict_ssl: "true", npm_package_scripts_build_n123: "yarn build-n1 && yarn build-n2 && yarn build-n3", GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_b8d39e58-1273-4863-a356-b32f71d58488", JAVA_HOME: "/usr/lib/jvm/temurin-17-jdk-amd64", PWD: "/home/runner/work/rainbow-d9/rainbow-d9/d9-sample-cra", GITHUB_ACTOR_ID: "2330098", RUNNER_WORKSPACE: "/home/runner/work/rainbow-d9", npm_execpath: "/opt/hostedtoolcache/node/18.20.7/x64/lib/node_modules/yarn/bin/yarn.js", npm_package_scripts_build_all_ci: "yarn build-ts-vfs-ci && yarn build-n123-ci && yarn build-n5-ci && yarn build-n6-ci && yarn build-code-editor-ci && yarn build-echarts-ci && yarn build-thai-all-ci && yarn build-npx-ci", HOMEBREW_CLEANUP_PERIODIC_FULL_DAYS: "3650", GITHUB_EVENT_NAME: "push", HOMEBREW_NO_AUTO_UPDATE: "1", ANDROID_HOME: "/usr/local/lib/android/sdk", GITHUB_SERVER_URL: "https://github.com", GECKOWEBDRIVER: "/usr/local/share/gecko_driver", GHCUP_INSTALL_BASE_PREFIX: "/usr/local", GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_b8d39e58-1273-4863-a356-b32f71d58488", npm_package_author_name: "Rainbow Team", EDGEWEBDRIVER: "/usr/local/share/edge_driver", STATS_EXT: "true", npm_package_scripts_build_n1_ci: "cd ./d9-n1 && yarn build-ci", npm_package_scripts_build_n99: "cd ./d9-n99 && yarn build", npm_config_save_prefix: "^", npm_config_ignore_optional: "", ANDROID_NDK: "/usr/local/lib/android/sdk/ndk/27.2.12479018", SGX_AESM_ADDR: "1", CHROME_BIN: "/usr/bin/google-chrome", npm_package_scripts_build_n2_ci: "cd ./d9-n2 && yarn build-ci", npm_package_scripts_build_npx: "cd ./create-rainbow-d9-app && yarn build", npm_package_scripts_deploy: "gh-pages -d build", npm_package_scripts_preview: "vite preview", SELENIUM_JAR_PATH: "/usr/share/java/selenium-server.jar", MEMORY_PRESSURE_WRITE: "c29tZSAyMDAwMDAgMjAwMDAwMAA=", STATS_EXTP: "https://provjobdprod.z13.web.core.windows.net/settings/provjobdsettings-latest/provjobd.data", npm_package_scripts_build_echarts_ci: "cd ./d9-echarts && yarn build-ci", npm_package_scripts_build_n3_ci: "cd ./d9-n3 && yarn build-ci", npm_package_dependencies_web_vitals: "^2.1.4", npm_package_dependencies_typescript: "5.6.3", INIT_CWD: "/home/runner/work/rainbow-d9/rainbow-d9", ANDROID_NDK_HOME: "/usr/local/lib/android/sdk/ndk/27.2.12479018", GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_b8d39e58-1273-4863-a356-b32f71d58488", npm_package_dependencies_react: "^18.3.1", npm_package_dependencies__types_react_dom: "^18.3.0", NODE_ENV: "production" };
...
const CodeEditor = reactExports.forwardRef((props, ref) => {
  const {
    ...
    C,
    $pp,
    $wrapped: { $onValueChange, $model, $avs: { $disabled, $visible } }
  } = props;
  const [state, setState] = reactExports.useState({});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(C, { "data-height": height, "data-disabled": $disabled, "data-visible": $visible, ref: divRef });
});
const JsEditorContainer = dt(EditorContainer).attrs(
...
const TsEditorContainer = dt(EditorContainer).attrs(
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-ignore
  ({ "data-height": height }) => {
    return {
...
const createJsExtensions = (options) => {
  const { jsx: jsx2 = false, typescript = false, createExtensions: givenCreateExtensions, ...rest } = options ?? {};
  const createExtensions = givenCreateExtensions ?? createCodeMirrorTs562Es2022Extensions;
  return () => {
    return [
      javascript({ jsx: jsx2, typescript }),
      ...createExtensions(rest)
    ];
  };
};
...
const UnwrappedJsEditor = reactExports.forwardRef((props, ref) => {
  const { $pp = "value", value, onValueChange, disabled, visible, ...rest } = props;
  const $onValueChange = onValueChange;
  const $avs = { $disabled: disabled, $visible: visible };
  const $root = { [$pp]: value };
...
const UnwrappedTsEditor = UnwrappedJsEditor;
...
class AbstractCodeEditorTranslator2 extends index$1.SpecificWidgetTranslator {
  beautifyProperties(def) {
    return super.beautifyProperties(this.beautifyColumnSpan(def, 12));
  }
  shouldWrapByFormCell() {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DemoSource, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DemoSourceHeader, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          UnwrappedButton,
          {
            onClick: onJsonDataRefreshClicked,
            ink: ButtonInk.INFO,
            disabled: activeSource !== "json",
            fill: ButtonFill.PLAIN,
            children: "Refresh Data"
          }
        )
      ] }),
      activeSource === "none" ? null : /* @__PURE__ */ jsxRuntimeExports.jsxs(
        DemoSourceBody,
        {
          "data-v-scroll": "",
          "data-h-scroll": "",
          "data-avoid-padding": activeSource === "json",
          children: [
            activeSource === "markdown" ? /* @__PURE__ */ jsxRuntimeExports.jsx(MarkdownContainer, { contents: markdown2 }) : null,
            activeSource === "json" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              UnwrappedTsEditor,
              {
                value: "const data = " + JSON.stringify(json, null, "	"),
...
`;
const App = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyleSheetManager, { children: [
