import { j as jsxRuntimeExports, r as reactExports, R as React, c as client } from "./react-o-VuPXsH.js";
import { r as registerCharts } from "./rainbow-d9-echarts-JYGz2qRV.js";
import { m as N1Logger, V as VUtils, P as PPUtils, M as MUtils, S as StandaloneRoot, f as useCreateEventBus, u as useThrottler, n as ExternalDefMismatchIndicator, B as BridgeEventBusProvider, o as useBridgeEventBus, p as BridgeToRootEventTypes, h as MBUtils, D as DeviceDetective } from "./rainbow-d9-n1-xf_6wIt7.js";
import { n as utils$2, m as GlobalRoot, $ as $d9n2, u as useGlobalEventBus, o as UnwrappedButtonBar, p as ButtonBarAlignment, U as UnwrappedButton, G as GlobalEventTypes, C as CssVars, q as UnwrappedSection, B as ButtonInk, e as ButtonFill } from "./rainbow-d9-n2-7ZnIJKq5.js";
import { i as index$1, r as registerN2Widgets, p as parseDoc } from "./rainbow-d9-n3-hD0a7J_-.js";
import { r as registerPlanSelect, u as useDemoMarkdown, C as CustomEventHandler, N as N2DemoDialogHandler, T as ThaiPlanSelection, a as ThaiPlanSelectionData, b as ThaiPlanSelectionMarkdown, P as PlanSelectionCssVars } from "./rainbow-d9-thai-plan-selection-Wp8L2-fl.js";
...
import { j as EditorView, k as EditorState, l as lineNumbers, o as syntaxHighlighting, q as markdown$a, r as defaultHighlightStyle, n as nanoid } from "./vendor-EJEFEpgY.js";
import { q as qe, $ as $e } from "./styled-components-JktVtKbu.js";
import { b as remarkGfm } from "./remark-bhrd1N_u.js";
import { R as ReactMarkdown } from "./react-markdown-Q79B_WnI.js";
import { S as SyntaxHighlighter, m as materialDark, _ as __vitePreload } from "./react-syntax-highlighter-5iEXhl0H.js";
import "./babel-AnpZxJH-.js";
import "./mdast-STkxI2lM.js";
import "./micromark-0B6Az_Rw.js";
import "./unist-5yxlKLF4.js";
import "./zrender-DEzoFf2M.js";
import "./emotion--D3psyId.js";
import "./property-information-COTsFz6V.js";
import "./refractor-B_wI0yEk.js";
import "./hastscript-j8-us0Ly.js";
(function polyfill() {
...
const D9EditorWrapper = qe.div.attrs(() => {
  return {
    ...
    overflow: hidden;
`;
const D9EditorPanel = qe.div.attrs({ "data-w": "d9-playground-editor-panel" })`
    display: block;
    position: relative;
    width: 100%;
    align-self: stretch;
...
`;
const D9Editor = (props) => {
  const { content, externalDefsTypes, ...rest } = props;
  ...
  return React.createElement(
    D9EditorWrapper,
    { ...rest },
    React.createElement(D9EditorPanel, { ref })
  );
};
...
const D9ViewerWrapper = qe.div.attrs(() => {
  return {
...
`;
const ParseError = qe.div.attrs({ "data-w": "d9-playground-viewer-error" })`
    display: flex;
    position: relative;
    align-items: center;
    padding: 16px 32px;
...
const D9Viewer = (props) => {
  ...
  try {
    ...
    return React.createElement(
      D9ViewerWrapper,
      null,
      React.createElement(StandaloneRoot, { ...def, "$root": model, externalDefs: enhancedExternalDefs })
    );
  } catch (error) {
    return React.createElement(
      D9ViewerWrapper,
...
const D9PlaygroundWrapper = qe.div.attrs(() => {
  return {
...
const PlaygroundDelegate = (props) => {
  const { content, onContentChanged, model, externalDefs, externalDefsTypes, ...rest } = props;
  const modelRef = reactExports.useRef(model ?? {});
  return React.createElement(
    D9PlaygroundWrapper,
    { ...rest },
    React.createElement(PlaygroundBridge, { onContentChanged }),
    React.createElement(D9Editor, { content, externalDefsTypes }),
    React.createElement(D9Viewer, { model: modelRef.current, externalDefs })
  );
};
const D9Playground = (props) => {
  return React.createElement(
...
const N2Playground = () => {
  let markdown2 = "# Page::Test Page\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n";
  const onMarkdownChanged = async (md) => {
    markdown2 = md;
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(D9Playground, { content: markdown2, onContentChanged: onMarkdownChanged });
};
const nestedTables = [
  {
...
const reportWebVitals = (onPerfEntry) => {
  if (onPerfEntry && onPerfEntry instanceof Function) {
    __vitePreload(() => import("./vendor-EJEFEpgY.js").then((n) => n.v), true ? __vite__mapDeps([0,1,2,3]) : void 0).then(({ getCLS, getFID, getFCP, getLCP, getTTFB }) => {
      getCLS(onPerfEntry);
      getFID(onPerfEntry);
      getFCP(onPerfEntry);
      getLCP(onPerfEntry);
...
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/vendor-EJEFEpgY.js","assets/babel-AnpZxJH-.js","assets/unist-5yxlKLF4.js","assets/vendor-UDnasYXb.css"]
  }
