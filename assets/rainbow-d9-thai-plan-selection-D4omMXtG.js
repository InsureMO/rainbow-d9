import { d as dt, r as reactExports, R as React, v as jsxRuntimeExports } from "./react-base-CLJUDc3W.js";
import { V as VUtils, r as registerWidget, g as useCreateEventBus, M as MUtils, P as PPUtils, a as useThrottler, e as useForceUpdate, d as Wrapper, S as StandaloneRoot } from "./rainbow-d9-n1-D7ZeHzAG.js";
import { C as CssVars, D as DOM_KEY_WIDGET, a as DOM_ID_WIDGET, d as utils$2, $ as $d9n2, b as useGlobalHandlers, u as useGlobalEventBus, G as GlobalEventTypes, U as UnwrappedButton, B as ButtonInk, e as ButtonFill, I as IntlLabel, L as LabelLike, i as index$2, o as index$1$1, c as GlobalEventPrefix, p as useAlert, q as useDialog, r as DialogHeader, s as DialogTitle, v as DialogBody, w as DialogFooter, x as GlobalRoot } from "./rainbow-d9-n2-C6huKoZ5.js";
import { a as color } from "./vendor-DmwmK4BQ.js";
import { i as index$1, p as parseDoc } from "./rainbow-d9-n3-DKRV7BUB.js";
var PlanElementType;
...
const APlanSelection = dt.div.attrs(({ id, "data-w": dataW, columnCount, computedColumnWidth, computedLineHeaderWidth, maxHeight }) => {
  return {
...
`;
const PlanSelectionTopLeftCorner = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-top-left-corner" })`
    display: flex;
    position: sticky;
    ...
    z-index: 3;
`;
const PlanSelectionPagination = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-pagination" })`
    display: flex;
    position: relative;
    align-items: center;
    justify-content: flex-end;
...
`;
const APlanHeader = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-header" })`
    display: flex;
    position: sticky;
    flex-direction: column;
    top: 0;
...
`;
const PlanHeaderTitle = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-header-title" })`
    display: flex;
    position: relative;
    align-items: center;
...
`;
const PlanHeaderSubTitle = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-header-sub-title" })`
    display: flex;
    position: relative;
    flex-direction: column;
    align-items: center;
...
`;
const PlanElementColumnHeader = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-element-header" })`
    display: flex;
    position: sticky;
    left: 0;
    align-items: center;
...
`;
const PlanElementColumnHeaderTitle = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-element-header-title" })`
    display: flex;
    position: relative;
    align-items: center;
...
`;
const PlanElementCellContainer = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-element-cell" })`
    display: flex;
    position: relative;
    flex-direction: column;
    align-items: center;
...
`;
const PlanElementUnitLabel = dt.span.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-element-unit" })`
    display: flex;
    position: relative;
    align-items: center;
...
`;
const PlanSelectionBottomLeftCorner = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-bottom-left-corner" })`
    display: block;
    position: sticky;
    bottom: 0;
    left: 0;
    ...
    z-index: 3;
`;
const PlanFooter = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-footer" })`
    display: flex;
    position: sticky;
    bottom: 0;
    flex-direction: column;
...
`;
const PlanFooterOperator = dt.div.attrs({ [DOM_KEY_WIDGET]: "d9-plan-selection-footer-operator" })`
    display: flex;
    position: relative;
    align-items: center;
    justify-content: center;
