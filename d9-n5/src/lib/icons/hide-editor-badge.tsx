...
export const HideEditorBadgeIcon = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="playground-hide-editor-badge" viewBox="0 0 24 24" fill="none"
	            xmlns="http://www.w3.org/2000/svg">
		<path d="M20.0297 2.47998L4.17969 18.33" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
