...
export const ChecksIcon = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="playground-checks" viewBox="-3 -3 20 20" xmlns="http://www.w3.org/2000/svg"
	            fill="currentColor">
		<path
