...
export const VFS_TS_562_ES2019_FILES = (full: boolean): Record<string, string> => {
	return {
		...VFS_TS_562_ES2018_FILES(full),
		...
		'/lib.es2019.full.d.ts': full ? es2019Full : es2019,
 ...
 */
export const VFS_TS_562_ES2019 = (): DtsMap => createDTSMap(VFS_TS_562_ES2019_FILES(false));
export const VFS_TS_562_ES2019_FULL = (): DtsMap => createDTSMapWithDOMGteEs2018(VFS_TS_562_ES2019_FILES(true));
