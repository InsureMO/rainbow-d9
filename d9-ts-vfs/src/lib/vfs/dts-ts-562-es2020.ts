...
export const VFS_TS_562_ES2020_FILES = (full: boolean): Record<string, string> => {
	return {
		...VFS_TS_562_ES2019_FILES(full),
		...
		'/lib.es2020.full.d.ts': full ? es2020Full : es2020,
 ...
 */
export const VFS_TS_562_ES2020 = (): DtsMap => createDTSMap(VFS_TS_562_ES2020_FILES(false));
export const VFS_TS_562_ES2020_FULL = (): DtsMap => createDTSMapWithDOMGteEs2018(VFS_TS_562_ES2020_FILES(true));
