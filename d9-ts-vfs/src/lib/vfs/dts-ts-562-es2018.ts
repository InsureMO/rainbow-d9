...
export const VFS_TS_562_ES2018_FILES = (): Record<string, string> => {
	return {
		...VFS_TS_562_ES2017_FILES(),
 ...
 */
export const VFS_TS_562_ES2018 = (): DtsMap => createDTSMap(VFS_TS_562_ES2018_FILES());
export const VFS_TS_562_ES2018_FULL = (): DtsMap => createDTSMapWithDOMGteEs2018(VFS_TS_562_ES2018_FILES());
