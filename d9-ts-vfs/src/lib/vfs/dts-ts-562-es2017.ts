...
export const VFS_TS_562_ES2017_FILES = (full: boolean): Record<string, string> => {
	return {
		...VFS_TS_562_ES2016_FILES(full),
		...
		'/lib.es2017.full.d.ts': full ? es2017Full : es2017,
 ...
 */
export const VFS_TS_562_ES2017 = (): DtsMap => createDTSMap(VFS_TS_562_ES2017_FILES(false));
export const VFS_TS_562_ES2017_FULL = (): DtsMap => createDTSMapWithDOMLtEs2018(VFS_TS_562_ES2017_FILES(true));
