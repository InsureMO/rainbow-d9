...
export const VFS_TS_562_ES2022_FILES = (full: boolean): Record<string, string> => {
	return {
		...VFS_TS_562_ES2021_FILES(full),
		...
		'/lib.es2022.full.d.ts': full ? es2022Full : es2022,
 ...
 */
export const VFS_TS_562_ES2022 = (): DtsMap => createDTSMap(VFS_TS_562_ES2022_FILES(false));
export const VFS_TS_562_ES2022_FULL = (): DtsMap => createDTSMapWithDOMGteEs2018(VFS_TS_562_ES2022_FILES(true));
