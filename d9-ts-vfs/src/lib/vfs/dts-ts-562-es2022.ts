...
export const VFS_TS_562_ES2022_FILES = (): Record<string, string> => {
	return {
		...VFS_TS_562_ES2021_FILES(),
 ...
 */
export const VFS_TS_562_ES2022 = (): DtsMap => createDTSMap(VFS_TS_562_ES2022_FILES());
export const VFS_TS_562_ES2022_FULL = (): DtsMap => createDTSMapWithDOMGteEs2018(VFS_TS_562_ES2022_FILES());
