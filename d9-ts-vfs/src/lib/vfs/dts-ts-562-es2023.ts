...
export const VFS_TS_562_ES2023_FILES = (full: boolean): Record<string, string> => {
	return {
		...VFS_TS_562_ES2022_FILES(full),
		...
		'/lib.es2023.full.d.ts': full ? es2023Full : es2023,
 ...
 */
export const VFS_TS_562_ES2023 = (): DtsMap => createDTSMap(VFS_TS_562_ES2023_FILES(false));
export const VFS_TS_562_ES2023_FULL = (): DtsMap => createDTSMapWithDOMGteEs2018(VFS_TS_562_ES2023_FILES(true));
