...
export const VFS_TS_562_ES2021_FILES = (full: boolean): Record<string, string> => {
	return {
		...VFS_TS_562_ES2020_FILES(full),
		'/lib.es2021.d.ts': es2021,
		// es2021.full is entry point, use es2021 to avoid unnecessary declarations
		'/lib.es2021.full.d.ts': full ? es2021Full : es2021,
 ...
 */
export const VFS_TS_562_ES2021 = (): DtsMap => createDTSMap(VFS_TS_562_ES2021_FILES(false));
export const VFS_TS_562_ES2021_FULL = (): DtsMap => createDTSMapWithDOMGteEs2018(VFS_TS_562_ES2021_FILES(true));
