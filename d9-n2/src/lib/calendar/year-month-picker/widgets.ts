...
export const YearMonthPickerContainer = styled.div.attrs({'data-w': 'd9-calendar-ym-picker'})`
    display: grid;
    position: relative;
    ...
    cursor: default;
`;
export const YearMonthPickerLabel = styled.div.attrs({'data-w': 'd9-calendar-ym-picker-label'})`
    display: flex;
    align-items: center;
...
`;
export const YearSelector = styled.div.attrs({'data-w': 'd9-calendar-ym-picker-year- selector', 'data-v-scroll': ''})`
    display: flex;
    ...
    overflow-y: scroll;
`;
export const YearSelectorOption = styled.span.attrs({'data-w': 'd9-calendar-ym-picker-year-selector-option'})`
    display: flex;
    position: relative;
    align-items: center;
...
`;
export const MonthSelector = styled.div.attrs({'data-w': 'd9-calendar-ym-picker-month-selector'})`
    display: grid;
    grid-template-columns: 1fr 1fr 1fr;
    grid-column-gap: ${CssVars.CALENDAR_GUTTER_SIZE};
    grid-row-gap: ${CssVars.CALENDAR_GUTTER_SIZE};
`;
export const MonthSelectorOption = styled.span.attrs({'data-w': 'd9-calendar-ym-picker-month-selector-option'})`
    display: flex;
    position: relative;
    align-items: center;
