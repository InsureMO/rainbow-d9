...
export const Backward = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	return <svg {...props} data-icon="forward" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
		<path opacity="1"
