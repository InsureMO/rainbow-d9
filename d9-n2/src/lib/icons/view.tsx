...
export const View = (props: Omit<SVGProps<SVGSVGElement>, 'xmlns' | 'viewBox'>) => {
	// original value: viewBox="0 0 24 24"
	return <svg {...props} data-icon="view" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
		<path
		...
		<circle cx="5.014" cy="18" r="1"/>
		<path d="M15.752,19a1.018,1.018,0,0,0,0-2H8.838a1.019,1.019,0,0,0,0,2Z"/>
		<path
